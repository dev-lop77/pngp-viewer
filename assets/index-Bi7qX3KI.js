...
`,Cv=!1;function wv(){Cv||(Cv=!0,K.fog_pars_vertex=`
  ...
  `,K.fog_fragment=`
    ...
    #endif
  `)}function Tv(e){e.fog=!1;let t=e.onBeforeCompile;return e.onBeforeCompile=(e,n)=>{t?.(e,n),Object.assign(e.uniforms,xv.uniforms),e.vertexShader=e.vertexShader.replace(`#include <fog_pars_vertex>`,`varying vec3 vAtmoWorld;`).replace(`#include <fog_vertex>`,`vAtmoWorld = (modelMatrix * vec4(position.y < 0.5 ? instanceStart : instanceEnd, 1.0)).xyz;`),e.fragmentShader=e.fragmentShader.replace(`#include <fog_pars_fragment>`,`varying vec3 vAtmoWorld;\n uniform vec3 uAtmoFogColor;\n ${Sv}`).replace(`#include <fog_fragment>`,`gl_FragColor.rgb = atmoApply(gl_FragColor.rgb, uAtmoFogColor, vAtmoWorld, cameraPosition);`)},e}function Ev(e){let t=e.onBeforeCompile;return e.onBeforeCompile=(e,n)=>{t?.(e,n),Object.assign(e.uniforms,xv.uniforms)},e}var Dv={value:null};function Ov(){let e=new bi(new Uint8Array([0]),1,1,D,l);return e.needsUpdate=!0,e}Dv.value=Ov();var kv=2;function Av({manifest:e,texture:t}){let{width:n,height:r}=e.dimensions,{xmin:i,ymin:a,xmax:o,ymax:s}=e.bboxCrsUnits,c=o-i,l=s-a,u=Math.ceil(n/kv),d=Math.ceil(r/kv),f=document.createElement(`canvas`);f.width=u,f.height=d;let p=f.getContext(`2d`);if(!p)return()=>0;p.drawImage(t.image,0,0,u,d);let m=p.getImageData(0,0,u,d).data,h=new Uint8Array(u*d);for(let e=0;e<h.length;e++)h[e]=m[e*4];return function(e,t){let n=Math.floor((e+c/2)/c*u),r=Math.floor((t+l/2)/l*d);return n<0||n>=u||r<0||r>=d?0:h[r*u+n]/255}}async function jv(e=`./data`){let n=await fetch(`${e}/forest.json`).then(e=>e.json()),r=await new Bo().loadAsync(`${e}/${n.file.name}`);return r.colorSpace=``,r.wrapS=t,r.wrapT=t,r.magFilter=o,r.minFilter=c,r.generateMipmaps=!0,r.needsUpdate=!0,Dv.value=r,{manifest:n,texture:r}}var Mv={value:null};function Nv(){let e=new bi(new Uint8Array([0,0,0,255]),1,1);return e.colorSpace=``,e.needsUpdate=!0,e}Mv.value=Nv();async function Pv(e=`./data`){let n=await fetch(`${e}/glacier.json`).then(e=>e.json()),r=await new Bo().loadAsync(`${e}/${n.file.name}`);return r.colorSpace=``,r.wrapS=t,r.wrapT=t,r.magFilter=o,r.minFilter=c,r.generateMipmaps=!0,r.needsUpdate=!0,Mv.value=r,{manifest:n,texture:r}}var Fv={value:0},Iv=16185855,Lv=3200,Rv=.3;function zv(e){let t=e.toPrecision(12);return t.includes(`.`)||t.includes(`e`)?t:`${t}.0`}function Bv(){let e=new G(Iv);return`vec3( ${zv(e.r)}, ${zv(e.g)}, ${zv(e.b)} )`}function Vv(){return`
    uniform float uSnow;
    ...
    float snowCover( vec2 wxz, float elev, float aspectZ, float bare ) {
      ...
      float line = mix( ${zv(Lv)}, ${zv(900)}, uSnow );
      float reach = smoothstep( 0.0, ${zv(Rv)}, uSnow );
      return smoothstep( line - ${zv(300)}, line + ${zv(300)}, hEff )
             * reach * ( 1.0 - bare );
    }
  `}function Hv(e,t,n){let r=Math.min(1,Math.max(0,(n-e)/(t-e)));return r*r*(3-2*r)}function Uv({elevM:e,aspectZ:t=0,bare:n=0,level:r,wobbleM:i=0}){if(!(r>0)||!Number.isFinite(e))return 0;let a=e+i-t*320,o=Lv+(900-Lv)*r,s=Hv(0,Rv,r);return Hv(o-300,o+300,a)*s*(1-n)}var Wv={value:null},Gv={value:0},Kv={value:0},qv=3.4,Jv=.1;function Yv(e){let t=e.toPrecision(12);return t.includes(`.`)||t.includes(`e`)?t:`${t}.0`}function Xv(){return`
    ...
    vec3 basemapAlbedo( vec2 uv, float detail ) {
      ...
      return photo * ( 1.0 + detail * ${Yv(Jv)} );
    }
  `}function Zv(){let e=new bi(new Uint8Array([128,128,128,255]),1,1);return e.needsUpdate=!0,e}Wv.value=Zv();function Qv(e,t){let n=e.levels??[];if(!n.length)throw Error(`basemap.json has no levels`);let r=n[0];for(let e of n){let{width:n,height:i}=e.dimensions;n<=t&&i<=t&&(r=e)}return r}async function $v(e=`./data`,{maxTextureSize:n=4096}={}){let r=await fetch(`${e}/basemap.json`).then(e=>e.json()),i=Qv(r,n),a=await new Bo().loadAsync(`${e}/${i.file.name}`);return a.colorSpace=Le,a.wrapS=t,a.wrapT=t,a.magFilter=o,a.minFilter=c,a.generateMipmaps=!0,a.anisotropy=4,a.needsUpdate=!0,Wv.value=a,Kv.value=r.encoding.fullScale*qv,Gv.value=1,{manifest:r,texture:a,level:i}}var ey={value:null},ty={value:4e3},ny={value:1500},ry={value:8e3};function iy(){let e=new bi(new Uint8Array([0]),1,1,D,l);return e.needsUpdate=!0,e}ey.value=iy();function ay({worldWidth:e,worldDepth:t}){let n=e=>{let t=e.toPrecision(12);return t.includes(`.`)||t.includes(`e`)?t:`${t}.0`};return`
  ...
  `}function oy(e,t,n){let r=Math.min(1,Math.max(0,(n-e)/(t-e)));return r*r*(3-2*r)}function sy({field:e,width:t,height:n,worldWidth:r,worldDepth:i,maxDistanceM:a}){return function(o,s){let c=Math.floor((o+r/2)/r*t),l=Math.floor((s+i/2)/i*n),u=c<0||c>=t||l<0||l>=n?a:e[l*t+c]/255*a,d=oy(0,ty.value,u),f=r/2-Math.abs(o),p=i/2-Math.abs(s),m=1-oy(0,ny.value,Math.min(f,p));return Math.min(1,Math.max(0,Math.max(d,m)))}}function cy({manifest:e,texture:t}){let{width:n,height:r}=e.dimensions,{xmin:i,ymin:a,xmax:o,ymax:s}=e.bboxCrsUnits,c=document.createElement(`canvas`);c.width=n,c.height=r;let l=c.getContext(`2d`);if(!l)return()=>0;l.drawImage(t.image,0,0,n,r);let u=l.getImageData(0,0,n,r).data,d=new Uint8Array(n*r);for(let e=0;e<d.length;e++)d[e]=u[e*4];return sy({field:d,width:n,height:r,worldWidth:o-i,worldDepth:s-a,maxDistanceM:e.encoding.maxDistanceM})}async function ly(e=`./data`){let n=await fetch(`${e}/outerring.json`).then(e=>e.json()),r=await new Bo().loadAsync(`${e}/${n.file.name}`);return r.colorSpace=``,r.wrapS=t,r.wrapT=t,r.magFilter=o,r.minFilter=o,r.generateMipmaps=!1,r.needsUpdate=!0,ey.value=r,ry.value=n.encoding.maxDistanceM,{manifest:n,texture:r}}var uy=1.5,dy=150;function fy(e){let t=e.toPrecision(12);return t.includes(`.`)||t.includes(`e`)?t:`${t}.0`}function py(e){let t=new G(e);return`vec3( ${fy(t.r)}, ${fy(t.g)}, ${fy(t.b)} )`}function my(e,t,n){if(!e.includes(t))throw Error(`terrain.js: shader marker not found, three.js internals may have changed: ${t}`);return e.replace(t,n)}var hy=[{name:`valley`,top:800,color:10599285},{name:`montane`,top:1600,color:7573861},{name:`subalpine`,top:2200,color:9282668},{name:`meadow`,top:3e3,color:12107401},{name:`rocky`,top:3800,color:11774623},{name:`nival`,top:1/0,color:16185855}],gy=150,_y=11774623,vy=6716766,yy=.9,by=16777215,xy={value:1},Sy=.57,Cy=.31,wy=.25,Ty=.87,Ey=.6;async function Dy(e=`./data`){let n=await fetch(`${e}/heightfield.json`).then(e=>e.json()),r=await fetch(`${e}/${n.file.name}`).then(e=>e.arrayBuffer()),i=ov(new Uint8Array(r),n),{width:a,height:s}=n.dimensions,{xmin:c,ymin:u,xmax:d,ymax:f}=n.bboxCrsUnits,{min:p,max:m}=n.elevationRangeM,{x:h,y:g}=n.resolutionMPerPx,_=d-c,v=f-u;tv(n.localOrigin.x,n.localOrigin.y);let y=new Uint8Array(i.length*2);for(let e=0;e<i.length;e++){let t=i[e];y[e*2]=t>>8,y[e*2+1]=t&255}let b=new bi(y,a,s,k,l);b.flipY=!0,b.magFilter=o,b.minFilter=o,b.wrapS=t,b.wrapT=t,b.generateMipmaps=!1,b.needsUpdate=!0;let x=new go({color:16777215,displacementMap:b,displacementScale:m-p,displacementBias:p,metalness:0,roughness:1}),S=`
...
${bv()}
  ...
  `,C=`
    ...
    vec2 nSpacing = max( vec2( ${fy(h)}, ${fy(g)} ), aCellM );
  ...
  `,w=hy.slice(1).map((e,t)=>{let n=hy[t].top;return`      albedo = mix( albedo, ${py(e.color)}, smoothstep( ${fy(n-gy)}, ${fy(n+gy)}, h ) );`}).join(`
`),T=`
    varying float vTerrainElev;
    varying vec3 vTerrainNormal;
    varying vec2 vTerrainXZ;
...
${ay({worldWidth:_,worldDepth:v})}
    ...
    vec3 terrainAlbedo() {
      ...
      // also right.
      float h = vTerrainElev + wobble * ${fy(75)} - n.z * ${fy(50)};

      vec3 albedo = ${py(hy[0].color)};
${w}
      ...
      // rock term below.
      vec2 fUv = vec2( ( vTerrainXZ.x + ${fy(_/2)} ) / ${fy(_)},
                       ( ${fy(v/2)} - vTerrainXZ.y ) / ${fy(v)} );
      ...
      albedo = mix( albedo, ${py(vy)},
                    wood * ${fy(yy)} * ( 1.0 - uBasemapMix ) );
      ...
      float bare = 1.0 - smoothstep( ${fy(Ey)}, ${fy(Ty)}, n.y );
      vec3 ground = mix( albedo, ${py(_y)}, bare * 0.9 );
      ...
      float iceSlope = mix( ${fy(wy)}, 1.0,
                            smoothstep( ${fy(Cy)}, ${fy(Sy)}, n.y ) );
      ground = mix( ground, ${py(by)}, clamp( ice * iceSlope, 0.0, 1.0 ) );
  ...
  diffuseColor.rgb *= terrainAlbedo();`),n=my(n,`#include <fog_fragment>`,`#include <fog_fragment>
		...
		`};var My=class extends mo{constructor(e){super({type:`LineMaterial`,uniforms:uo.clone(Ls.line.uniforms),vertexShader:Ls.line.vertexShader,fragmentShader:Ls.line.fragmentShader,clipping:!0}),this.isLineMaterial=!0,this.setValues(e)}get color(){return this.uniforms.diffuse.value}set color(e){this.uniforms.diffuse.value=e}get worldUnits(){return`WORLD_UNITS`in this.defines}set worldUnits(e){e===!0!==this.worldUnits&&(this.needsUpdate=!0),e===!0?this.defines.WORLD_UNITS=``:delete this.defines.WORLD_UNITS}get linewidth(){return this.uniforms.linewidth.value}set linewidth(e){this.uniforms.linewidth&&(this.uniforms.linewidth.value=e)}get dashed(){return`USE_DASH`in this.defines}set dashed(e){e===!0!==this.dashed&&(this.needsUpdate=!0),e===!0?this.defines.USE_DASH=``:delete this.defines.USE_DASH}get dashScale(){return this.uniforms.dashScale.value}set dashScale(e){this.uniforms.dashScale.value=e}get dashSize(){return this.uniforms.dashSize.value}set dashSize(e){this.uniforms.dashSize.value=e}get dashOffset(){return this.uniforms.dashOffset.value}set dashOffset(e){this.uniforms.dashOffset.value=e}get gapSize(){return this.uniforms.gapSize.value}set gapSize(e){this.uniforms.gapSize.value=e}get opacity(){return this.uniforms.opacity.value}set opacity(e){this.uniforms&&(this.uniforms.opacity.value=e)}get resolution(){return this.uniforms.resolution.value}set resolution(e){this.uniforms.resolution.value.copy(e)}get alphaToCoverage(){return`USE_ALPHA_TO_COVERAGE`in this.defines}set alphaToCoverage(e){this.defines&&(e===!0!==this.alphaToCoverage&&(this.needsUpdate=!0),e===!0?this.defines.USE_ALPHA_TO_COVERAGE=``:delete this.defines.USE_ALPHA_TO_COVERAGE)}},Ny=new Kt,Py=new U,Fy=new U,Iy=new Kt,Ly=new Kt,Ry=new Kt,zy=new U,By=new Zt,Vy=new js,Hy=new U,Uy=new Xn,Wy=new xr,Gy=new Kt,Ky,qy;function Jy(e,t,n){return Gy.set(0,0,-t,1).applyMatrix4(e.projectionMatrix),Gy.multiplyScalar(1/Gy.w),Gy.x=qy/n.width,Gy.y=qy/n.height,Gy.applyMatrix4(e.projectionMatrixInverse),Gy.multiplyScalar(1/Gy.w),Math.abs(Math.max(Gy.x,Gy.y))}function Yy(e,t){let n=e.matrixWorld,r=e.geometry,i=r.attributes.instanceStart,a=r.attributes.instanceEnd,o=Math.min(r.instanceCount,i.count);for(let r=0,s=o;r<s;r++){Vy.start.fromBufferAttribute(i,r),Vy.end.fromBufferAttribute(a,r),Vy.applyMatrix4(n);let o=new U,s=new U;Ky.distanceSqToSegment(Vy.start,Vy.end,s,o),s.distanceTo(o)<qy*.5&&t.push({point:s,pointOnLine:o,distance:Ky.origin.distanceTo(s),object:e,face:null,faceIndex:r,uv:null,uv1:null})}}function Xy(e,t,n){let r=t.projectionMatrix,i=e.material.resolution,a=e.matrixWorld,o=e.geometry,s=o.attributes.instanceStart,c=o.attributes.instanceEnd,l=Math.min(o.instanceCount,s.count),u=-t.near;Ky.at(1,Ry),Ry.w=1,Ry.applyMatrix4(t.matrixWorldInverse),Ry.applyMatrix4(r),Ry.multiplyScalar(1/Ry.w),Ry.x*=i.x/2,Ry.y*=i.y/2,Ry.z=0,zy.copy(Ry),By.multiplyMatrices(t.matrixWorldInverse,a);for(let t=0,o=l;t<o;t++){if(Iy.fromBufferAttribute(s,t),Ly.fromBufferAttribute(c,t),Iy.w=1,Ly.w=1,Iy.applyMatrix4(By),Ly.applyMatrix4(By),Iy.z>u&&Ly.z>u)continue;if(Iy.z>u){let e=Iy.z-Ly.z,t=(Iy.z-u)/e;Iy.lerp(Ly,t)}else if(Ly.z>u){let e=Ly.z-Iy.z,t=(Ly.z-u)/e;Ly.lerp(Iy,t)}Iy.applyMatrix4(r),Ly.applyMatrix4(r),Iy.multiplyScalar(1/Iy.w),Ly.multiplyScalar(1/Ly.w),Iy.x*=i.x/2,Iy.y*=i.y/2,Ly.x*=i.x/2,Ly.y*=i.y/2,Vy.start.copy(Iy),Vy.start.z=0,Vy.end.copy(Ly),Vy.end.z=0;let o=Vy.closestPointToPointParameter(zy,!0);Vy.at(o,Hy);let l=Dt.lerp(Iy.z,Ly.z,o),d=l>=-1&&l<=1,f=zy.distanceTo(Hy)<qy*.5;if(d&&f){Vy.start.fromBufferAttribute(s,t),Vy.end.fromBufferAttribute(c,t),Vy.start.applyMatrix4(a),Vy.end.applyMatrix4(a);let r=new U,i=new U;Ky.distanceSqToSegment(Vy.start,Vy.end,i,r),n.push({point:i,pointOnLine:r,distance:Ky.origin.distanceTo(i),object:e,face:null,faceIndex:t,uv:null,uv1:null})}}}var Zy=class extends _i{constructor(e=new jy,t=new My({color:Math.random()*16777215})){super(e,t),this.isLineSegments2=!0,this.type=`LineSegments2`}computeLineDistances(){let e=this.geometry,t=e.attributes.instanceStart,n=e.attributes.instanceEnd,r=new Float32Array(2*t.count);for(let e=0,i=0,a=t.count;e<a;e++,i+=2)Py.fromBufferAttribute(t,e),Fy.fromBufferAttribute(n,e),r[i]=i===0?0:r[i-1],r[i+1]=r[i]+Py.distanceTo(Fy);let i=new Cs(r,2,1);return e.setAttribute(`instanceDistanceStart`,new Mr(i,1,0)),e.setAttribute(`instanceDistanceEnd`,new Mr(i,1,1)),this}raycast(e,t){let n=this.material.worldUnits,r=e.camera;if(r===null&&!n&&console.error(`LineSegments2: "Raycaster.camera" needs to be set in order to raycast against LineSegments2 while worldUnits is set to false.`),n===!1&&(this.material.resolution.x===0||this.material.resolution.y===0))return;let i=e.params.Line2===void 0?0:e.params.Line2.threshold||0;Ky=e.ray;let a=this.matrixWorld,o=this.geometry,s=this.material;qy=s.linewidth+i,o.boundingSphere===null&&o.computeBoundingSphere(),Wy.copy(o.boundingSphere).applyMatrix4(a);let c;if(c=n?qy*.5:Jy(r,Math.max(r.near,Wy.distanceToPoint(Ky.origin)),s.resolution),Wy.radius+=c,Ky.intersectsSphere(Wy)===!1)return;o.boundingBox===null&&o.computeBoundingBox(),Uy.copy(o.boundingBox).applyMatrix4(a);let l;l=n?qy*.5:Jy(r,Math.max(r.near,Uy.distanceToPoint(Ky.origin)),s.resolution),Uy.expandByScalar(l),Ky.intersectsBox(Uy)!==!1&&(n?Yy(this,t):Xy(this,r,t))}onBeforeRender(e){let t=this.material.uniforms;t&&t.resolution&&(e.getViewport(Ny),this.material.uniforms.resolution.value.set(Ny.z,Ny.w))}},Qy=10,$y=40,eb=40;function tb(e,t,n){if(!e)return!1;let{x:r,y:i,z:a}=t.position,o=n.x-r,s=n.y-i,c=n.z-a,l=Math.min(eb,Math.max(4,Math.round(Math.hypot(o,c)/$y)));for(let t=1;t<l;t++){let n=t/l;if(e(r+o*n,a+c*n)>i+s*n+Qy)return!0}return!1}function nb(e,t){if(e.length<2)return e;let n=[e[0]];for(let r=1;r<e.length;r++){let[i,a,o]=e[r-1],[s,c,l]=e[r],u=Math.hypot(s-i,l-o),d=Math.ceil(u/t);for(let e=1;e<d;e++){let t=e/d;n.push([i+(s-i)*t,a+(c-a)*t,o+(l-o)*t])}n.push(e[r])}return n}var rb=11740702,ib={T:`solid`,E:`dashed`,EE:`dotted`,EEA:`ferrata`},ab=`solid`,ob=.5,sb=8,cb=6,lb=1.2,ub=400,db=6,fb=1.5,pb=.02,mb=15909376,hb=3,gb=ob,_b=2e3,vb=400,yb=6e3,bb=18,xb=1.5,Sb=.006;function Cb(e,t,n,r,i,a,o){e.push(t,n+ob,r,i,a+ob,o)}function wb(e,t){for(let n=1;n<t.length;n++){let[r,i,a]=t[n-1],[o,s,c]=t[n];Cb(e,r,i,a,o,s,c)}}function Tb(e,t){let n=0;for(let r=1;r<t.length;r++){let[i,a,o]=t[r-1],[s,c,l]=t[r],u=s-i,d=l-o,f=Math.hypot(u,d);if(f===0)continue;let p=u/f,m=d/f,h=-m,g=p,_=cb-n;for(;_<f;){let t=_/f,n=i+u*t,r=a+(c-a)*t,s=o+d*t,l=lb;Cb(e,n-(p+h)*l,r,s-(m+g)*l,n+(p+h)*l,r,s+(m+g)*l),Cb(e,n-(p-h)*l,r,s-(m-g)*l,n+(p-h)*l,r,s+(m-g)*l),_+=cb}n=(n+f)%cb}}function Eb(e,t,n){let r=new kr;r.setAttribute(`position`,new _r(e,3));let i=new Xi(r,t);return t.isLineDashedMaterial&&i.computeLineDistances(),i.name=n,i}var Db=`http://www.w3.org/2000/svg`;function Ob(e){let t=document.createElementNS(Db,`svg`);t.setAttribute(`viewBox`,`0 0 24 22`),t.setAttribute(`aria-hidden`,`true`);let n=document.createElementNS(Db,`path`);n.setAttribute(`d`,`M12 3 L21.5 19 L2.5 19 Z`),t.append(n);let r=document.createElementNS(Db,`text`);return r.setAttribute(`x`,`12`),r.setAttribute(`y`,`17.4`),r.textContent=String(e),t.append(r),t}function kb(e){let t=[e.segnavia,e.name].filter(e=>e&&String(e).trim());return e.ferrataScale&&t.push(`ferrata ${e.ferrataScale}`),t.join(` · `)}function Ab(e){let t=1/0,n=-1/0,r=1/0,i=-1/0;for(let a of e)for(let[e,,o]of a)e<t&&(t=e),e>n&&(n=e),o<r&&(r=o),o>i&&(i=o);return{x0:t,x1:n,z0:r,z1:i}}function jb(e,t,n){let r=Math.max(e.x0-t,0,t-e.x1),i=Math.max(e.z0-n,0,n-e.z1);return Math.hypot(r,i)}function Mb(e,t,n){let r=[],i=n;for(let n=1;n<e.length;n++){let[a,o,s]=e[n-1],[c,l,u]=e[n],d=Math.hypot(c-a,u-s);if(d===0)continue;let f=t-i;for(;f<d;){let e=f/d;r.push([a+(c-a)*e,o+(l-o)*e,s+(u-s)*e]),f+=t}i=(i+d)%t}return r}async function Nb(e=`./data`){let[t,n]=await Promise.all([fetch(`${e}/trails.json`).then(e=>e.json()),fetch(`${e}/ferrata.json`).then(e=>e.ok?e.json():null).catch(()=>null)]),r=n?.ferrata?.length?[...t.trails,...n.ferrata]:t.trails,i={solid:[],dashed:[],dotted:[],ferrata:[]},a=[],o=[];for(let e of r){let t=ib[e.difficulty]??ab;for(let n of e.lines){let r=nb(n,sb);if(wb(i[t],r),t===`ferrata`&&Tb(a,n),e.altaVia)for(let e=1;e<r.length;e++){let[t,n,i]=r[e-1],[a,s,c]=r[e];o.push(t,n+gb,i,a,s+gb,c)}}}let s=new En;s.name=`trails`;let c=[],l=null,u=null,d=null;if(o.length){u=new Float32Array(o);let e=new jy;e.setPositions(u),d=Tv(new My({color:mb,linewidth:hb,transparent:!0,opacity:.85,depthWrite:!1,resolution:new H(window.innerWidth,window.innerHeight)})),l=new Zy(e,d),l.name=`trails-alta-via-casing`,l.renderOrder=-1,s.add(l)}let f=[];for(let e of r){let t=kb(e);if(!t)continue;let n=document.createElement(`div`);n.className=`trail-label`,n.textContent=t;let r=new Qu(n);r.center.set(.5,1),r.visible=!1;let[i,a,o]=e.lines[0][0];r.position.set(i,a+db,o),s.add(r),f.push({object:r,lines:e.lines,bounds:Ab(e.lines)})}let p=[];for(let e of r)if(e.altaVia)for(let t of e.lines)for(let[n,r,i]of Mb(t,_b,_b/2)){if(p.some(e=>Math.hypot(e.x-n,e.z-i)<vb))continue;let t=document.createElement(`div`);t.className=`av-badge`,t.title=`Alta Via ${e.altaVia}`,t.append(Ob(e.altaVia));let a=new Qu(t);a.center.set(.5,1),a.visible=!1,a.position.set(n,r+bb,i),s.add(a),p.push({object:a,x:n,z:i,groundY:r})}if(i.solid.length&&c.push(Eb(i.solid,Ev(new Ri({color:rb})),`trails-solid`)),i.dashed.length){let e=Ev(new yo({color:rb,dashSize:30,gapSize:20}));c.push(Eb(i.dashed,e,`trails-dashed`))}if(i.dotted.length){let e=Ev(new yo({color:rb,dashSize:4,gapSize:16}));c.push(Eb(i.dotted,e,`trails-dotted`))}if(i.ferrata.length){let e=Ev(new Ri({color:rb}));c.push(Eb(i.ferrata,e,`trails-ferrata-line`)),c.push(Eb(a,e,`trails-ferrata-ticks`))}for(let e of c)s.add(e);let m=null;function h(e){m=e;for(let t of c){let n=t.geometry.getAttribute(`position`),r=n.array;for(let t=0;t<r.length;t+=3)r[t+1]=e(r[t],r[t+2])+ob;n.needsUpdate=!0,t.geometry.computeBoundingSphere(),t.material.isLineDashedMaterial&&t.computeLineDistances()}if(l){for(let t=0;t<u.length;t+=3)u[t+1]=e(u[t],u[t+2])+gb;l.geometry.attributes.instanceStart.data.needsUpdate=!0,l.geometry.computeBoundingSphere()}for(let t of p)t.groundY=e(t.x,t.z)}function g(e){let{x:t,y:n,z:r}=e.position;for(let i of f){if(jb(i.bounds,t,r)>ub){i.object.visible=!1;continue}let a=0,o=0,s=0,c=1/0;for(let e of i.lines)for(let[n,i,l]of e){let e=(n-t)*(n-t)+(l-r)*(l-r);e<c&&(c=e,a=n,o=i,s=l)}let l=m?m(a,s):o,u=Math.hypot(a-t,l-n,s-r);if(u>ub){i.object.visible=!1;continue}let d=Math.min(db,Math.max(fb,u*pb));i.object.position.set(a,l+d,s),i.object.visible=!tb(m,e,i.object.position)}for(let i of p){let a=Math.hypot(i.x-t,i.groundY-n,i.z-r);if(a>yb){i.object.visible=!1;continue}let o=Math.min(bb,Math.max(xb,a*Sb));i.object.position.set(i.x,i.groundY+o,i.z),i.object.visible=!tb(m,e,i.object.position)}}function _(e,t){d?.resolution.set(e,t)}return{group:s,manifest:t,ferrataManifest:n,alignToGround:h,updateLabels:g,setResolution:_}}var Pb={peak:{color:16777215},hut:{color:12679743},pass:{color:11225020},waterfall:{color:2733814},lake:{color:2001125},trailhead:{color:6732650},village:{color:14734264}},Fb={peak:`Peak`,hut:`Mountain hut`,pass:`Pass`,waterfall:`Waterfall`,lake:`Lake`,trailhead:`Trailhead`,village:`Village`};function Ib(e){return e.category===`hut`&&e.hutKind===`shelter:basic_hut`?`Bivouac hut`:e.category===`village`&&e.placeKind===`hamlet`?`Hamlet`:Fb[e.category]??e.category}var Lb=12,Rb=1.5,zb=.02,Bb=1500,Vb=2;async function Hb(e=`./data`,{onSelect:t}={}){let n=await fetch(`${e}/poi.json`).then(e=>e.json()),r=new Map;for(let e of n.pois){let t=r.get(e.category);t||r.set(e.category,t=[]),t.push(e)}let i=new En;i.name=`poi`;let a=[],o=[];for(let[e,n]of r){let r=Pb[e]??{color:16777215},s=new Float32Array(n.length*6);n.forEach((e,t)=>Ub(s,t,e.local.x,e.local.z,e.elevationM,Lb));let c=new kr,l=new mr(s,3);c.setAttribute(`position`,l);let u=new Xi(c,Ev(new Ri({color:r.color,transparent:!0,opacity:.75})));u.name=`poi-${e}`,i.add(u),a.push(c),n.forEach((e,n)=>{let a=document.createElement(`div`);a.className=`poi-label`,a.style.setProperty(`--poi-color`,`#${r.color.toString(16).padStart(6,`0`)}`),a.textContent=e.name,a.addEventListener(`click`,n=>{n.stopPropagation(),t?.(e)});let s=new Qu(a);s.center.set(.5,1),s.position.set(e.local.x,e.elevationM+Lb,e.local.z),i.add(s),o.push({poi:e,object:s,attr:l,index:n,groundY:e.elevationM})})}let s=null,c=null;function l(e){c=e}function u(e){s=e;for(let t of o)t.groundY=e(t.poi.local.x,t.poi.local.z);d(null)}function d(e){for(let t of o){let{poi:n,object:r,attr:i,index:a,groundY:o}=t,l=e?Math.hypot(n.local.x-e.position.x,o-e.position.y,n.local.z-e.position.z):1/0,u=Math.min(Lb,Math.max(Rb,l*zb));Ub(i.array,a,n.local.x,n.local.z,o,u,c?.(n)===!0),r.position.set(n.local.x,o+u,n.local.z),r.visible=e?l<=Bb&&!tb(s,e,r.position):!1}for(let e of a)e.getAttribute(`position`).needsUpdate=!0,e.computeBoundingSphere()}return{group:i,manifest:n,alignToGround:u,updateMarkers:d,searchEntries:n.pois.map(e=>({label:`${e.name} · ${Ib(e)}`,poi:e})),setBuildingProbe:l}}function Ub(e,t,n,r,i,a,o=!1){let s=i-Vb;e[t*6]=n,e[t*6+1]=s,e[t*6+2]=r,e[t*6+3]=n,e[t*6+4]=o?s:i+a,e[t*6+5]=r}function Wb(e){let t=Ib(e),n=`<div class="name">${e.name}</div><div>${t} · ${Math.round(e.elevationM)} m</div>`;return e.dataIncomplete&&(n+=`<div class="warning">⚠ incomplete elevation data in this area</div>`),n}function Gb(e,t=!1){let n=e[0].index!==null,r=new Set(Object.keys(e[0].attributes)),i=new Set(Object.keys(e[0].morphAttributes)),a={},o={},s=e[0].morphTargetsRelative,c=new kr,l=0;for(let u=0;u<e.length;++u){let d=e[u],f=0;if(n!==(d.index!==null))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them.`),null;for(let e in d.attributes){if(!r.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure "`+e+`" attribute exists among all geometries, or in none of them.`),null;a[e]===void 0&&(a[e]=[]),a[e].push(d.attributes[e]),f++}if(f!==r.size)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. Make sure all geometries have the same number of attributes.`),null;if(s!==d.morphTargetsRelative)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. .morphTargetsRelative must be consistent throughout all geometries.`),null;for(let e in d.morphAttributes){if(!i.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`.  .morphAttributes must be consistent throughout all geometries.`),null;o[e]===void 0&&(o[e]=[]),o[e].push(d.morphAttributes[e])}if(t){let e;if(n)e=d.index.count;else if(d.attributes.position!==void 0)e=d.attributes.position.count;else return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. The geometry must have either an index or a position attribute`),null;c.addGroup(l,e,u),l+=e}}if(n){let t=0,n=[];for(let r=0;r<e.length;++r){let i=e[r].index;for(let e=0;e<i.count;++e)n.push(i.getX(e)+t);t+=e[r].attributes.position.count}c.setIndex(n)}for(let e in a){let t=Kb(a[e]);if(!t)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` attribute.`),null;c.setAttribute(e,t)}for(let e in o){let t=o[e][0].length;if(t!==0){c.morphAttributes=c.morphAttributes||{},c.morphAttributes[e]=[];for(let n=0;n<t;++n){let t=[];for(let r=0;r<o[e].length;++r)t.push(o[e][r][n]);let r=Kb(t);if(!r)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` morphAttribute.`),null;c.morphAttributes[e].push(r)}}}return c}function Kb(e){let t,n,r,i=-1,a=0;for(let o=0;o<e.length;++o){let s=e[o];if(t===void 0&&(t=s.array.constructor),t!==s.array.constructor)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes.`),null;if(n===void 0&&(n=s.itemSize),n!==s.itemSize)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes.`),null;if(r===void 0&&(r=s.normalized),r!==s.normalized)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes.`),null;if(i===-1&&(i=s.gpuType),i!==s.gpuType)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes.`),null;a+=s.count*n}let o=new t(a),s=new mr(o,n,r),c=0;for(let t=0;t<e.length;++t){let r=e[t];if(r.isInterleavedBufferAttribute){let e=c/n;for(let t=0,i=r.count;t<i;t++)for(let i=0;i<n;i++){let n=r.getComponent(t,i);s.setComponent(t+e,i,n)}}else o.set(r.array,c);c+=r.count*n}return i!==void 0&&(s.gpuType=i),s}var qb={value:0};function Jb(e){qb.value=+!!e}var Yb={stone:12762290,render:15590096,slate:7435900,wood:10584163,board:8612439,wallStone:11182742,shingle:7301991,timber:11705989,flagGreen:2528841,flagWhite:16777215,flagRed:16340044,orange:16153396,dark:5725025};function Xb(e,t){e.deleteAttribute(`uv`);let n=e.index?e.toNonIndexed():e,r=n.attributes.position.count,i=new Float32Array(r*3),a=new G(t);for(let e=0;e<r;e+=1)i[e*3]=a.r,i[e*3+1]=a.g,i[e*3+2]=a.b;return n.setAttribute(`color`,new mr(i,3)),n}function Zb(e,t,n,r,i,a){let o=new la(e,t,n);return o.translate(r,i,a),o}function Qb(e,t,n,r,i=0,a=.24){let o=e/2+i,s=t/2+i,c=r-n,l=s,u=Math.hypot(l,c),d=Math.atan2(c,l),f=[];for(let e of[1,-1]){let t=new la(o*2,a,u+a);t.rotateX(d),e===-1&&t.rotateY(Math.PI);let r=e*l/2,i=n+c/2;t.translate(0,i+Math.cos(d)*a/2,r+e*Math.sin(d)*a/2),f.push(t)}return f}function $b(e,t,n,r){let i=e/2,a=t/2,o=[],s=(...e)=>e.forEach(e=>o.push(...e));return s([-i,n,a],[-i,r,0],[-i,n,-a]),s([i,n,a],[i,n,-a],[i,r,0]),ex(o)}function ex(e){let t=new kr;return t.setAttribute(`position`,new mr(new Float32Array(e),3)),t.computeVertexNormals(),t}function tx(e,t,n,r,i,a=1){let o=new eo(e,t);return a===-1&&o.rotateY(Math.PI),o.translate(n,r,i+.04*a),o}function nx(e,t,n,r,i,a=1){let o=new eo(e,t);return o.rotateY(a*Math.PI/2),o.translate(n+.04*a,r,i),o}var rx={w:9.5,d:7,base:2.7,upper:2.5,rise:3.4};function ix(){let{w:e,d:t,base:n,upper:r,rise:i}=rx,a=n+r,o=a+i,s=[Xb(Zb(e,n,t,0,n/2,0),Yb.wallStone),Xb(Zb(e-.1,r,t-.1,0,n+r/2,0),Yb.board),Xb($b(e-.1,t-.1,a,o),Yb.board),Xb(Zb(e+.16,.26,t+.16,0,a-.13,0),Yb.timber),...Qb(e,t,a,o,.28).map(e=>Xb(e,Yb.shingle)),Xb(Zb(e+.56,.2,.12,0,a+.02,t/2+.28),Yb.timber),Xb(Zb(e+.56,.2,.12,0,a+.02,-(t/2+.28)),Yb.timber),Xb(Zb(.7,1.8,.7,e*.3,o-.5,0),Yb.stone),Xb(Zb(e+.5,.18,1.3,0,n+.1,t/2+.5),Yb.timber),Xb(Zb(e+.5,.85,.14,0,n+.62,t/2+1.1),Yb.timber),Xb(Zb(.16,n,.16,-(e/2-.3),n/2,t/2+1),Yb.timber),Xb(Zb(.16,n,.16,e/2-.3,n/2,t/2+1),Yb.timber),Xb(tx(1.05,2.1,0,1.05,t/2),Yb.dark)];for(let e of[-3.1,3.1])s.push(Xb(tx(.8,1.05,e,1.5,t/2),Yb.dark)),s.push(Xb(tx(.8,1.05,e,1.5,-t/2,-1),Yb.dark));for(let e of[-2.4,2.4])s.push(Xb(tx(.9,1,e,n+1.5,t/2),Yb.dark)),s.push(Xb(tx(.3,1,e-.62,n+1.5,t/2+.01),Yb.timber)),s.push(Xb(tx(.3,1,e+.62,n+1.5,t/2+.01),Yb.timber)),s.push(Xb(tx(.9,1,e,n+1.5,-t/2,-1),Yb.dark));for(let t of[1,-1])s.push(Xb(nx(.7,.8,t*(e-.1)/2,a+.85,0,t),Yb.dark));return s}function ax(){let{w:e,d:t,base:n,upper:r,rise:i}=rx,a=n+r,o=a+i;return[Xb(Zb(e,n,t,0,n/2,0),Yb.wallStone),Xb(Zb(e-.1,r,t-.1,0,n+r/2,0),Yb.board),Xb($b(e-.1,t-.1,a,o),Yb.board),Xb(Zb(e+.16,.26,t+.16,0,a-.13,0),Yb.timber),...Qb(e,t,a,o,.28).map(e=>Xb(e,Yb.shingle))]}var ox={len:3.6,w:2.6,wall:.75,r:1.3,plinth:.22};function sx(){let{len:e,w:t,wall:n,r,plinth:i}=ox,a=i+n,o=new fa(r,r,e,10,1,!0,0,Math.PI);o.rotateZ(Math.PI/2),o.rotateY(Math.PI/2),o.translate(0,a,0);let s=[Xb(Zb(t+.2,i,e+.2,0,i/2,0),Yb.stone),Xb(Zb(t,n,e,0,i+n/2,0),Yb.orange),Xb(o,Yb.orange)];for(let[t,n]of[[e/2,1],[-e/2,-1]]){let e=new da(r,10,0,Math.PI);n===-1&&e.rotateY(Math.PI),e.translate(0,a,t),s.push(Xb(e,Yb.orange))}return s.push(Xb(tx(.7,1.55,0,i+.8,e/2),Yb.dark)),s.push(Xb(tx(.34,.22,.62,i+1.25,e/2),Yb.render)),s}function cx(){let{len:e,w:t,wall:n,r,plinth:i}=ox,a=i+n,o=new fa(r,r,e,6,1,!0,0,Math.PI);o.rotateZ(Math.PI/2),o.rotateY(Math.PI/2),o.translate(0,a,0);let s=[Xb(Zb(t+.2,i,e+.2,0,i/2,0),Yb.stone),Xb(Zb(t,n,e,0,i+n/2,0),Yb.orange),Xb(o,Yb.orange)];for(let[t,n]of[[e/2,1],[-e/2,-1]]){let e=new da(r,6,0,Math.PI);n===-1&&e.rotateY(Math.PI),e.translate(0,a,t),s.push(Xb(e,Yb.orange))}return s}function lx(){let{len:e,w:t,plinth:n}=ox,r=sx(),i=t/2+.45,a=2.75;return r.push(Xb(Zb(.09,a-n,.09,i,n+(a-n)/2,e/2-.3),Yb.timber)),[Yb.flagGreen,Yb.flagWhite,Yb.flagRed].forEach((t,n)=>{r.push(Xb(tx(.36,.72,i+.18+n*.36,a-.42,e/2-.3),t))}),r}var ux={rifugio:ix,bivouac:sx},dx={rifugio:ix,bivouac:lx},fx={rifugio:ax,bivouac:cx},px={rifugio:{w:10.2,d:10.2},bivouac:{w:3.1,d:4.1}},mx={alpine_hut:`rifugio`,wilderness_hut:`bivouac`,"shelter:basic_hut":`bivouac`},hx={alpine_hut:1,wilderness_hut:1.3,"shelter:basic_hut":1},gx=30;function _x(e,t,n,r,i,a){let o=Math.cos(a),s=Math.sin(a),c=1/0,l=-1/0;for(let[a,u]of[[-r/2,-i/2],[r/2,-i/2],[-r/2,i/2],[r/2,i/2]]){let r=e(t+a*o+u*s,n-a*s+u*o);Number.isFinite(r)&&(c=Math.min(c,r),l=Math.max(l,r))}return Number.isFinite(c)?{y:l,drop:l-c+.5}:{y:e(t,n)??0,drop:.5}}function vx(e,t,n){let r=(e(t+12,n)??0)-(e(t-12,n)??0),i=(e(t,n+12)??0)-(e(t,n-12)??0);return Math.abs(r)<.001&&Math.abs(i)<.001?0:Math.atan2(-r,-i)}function yx({pois:e,sampleHeight:t}){let n=new En;n.name=`huts`;let r=e.map(e=>{let n=mx[e.hutKind]??`bivouac`,r=hx[e.hutKind]??1,{x:i,z:a}=e.local,o=vx(t,i,a),s=px[n],{y:c,drop:l}=_x(t,i,a,s.w*r,s.d*r,o);return{poi:e,kind:n,scale:r,x:i,z:a,y:c,yaw:o,drop:l}}),i=new go({vertexColors:!0,roughness:.85,metalness:0,flatShading:!0});Ev(i);function a(e,t,r,a){let o=new ki(Gb(t[r]()),i,Math.max(a,1));return o.name=`huts-${e}`,o.instanceMatrix.setUsage(Ue),o.count=0,o.frustumCulled=!1,o.castShadow=!1,o.receiveShadow=!1,n.add(o),o}let o={rifugio:0,bivouac:0};for(let e of r)o[e.kind]+=1;let s={};for(let e of[`rifugio`,`bivouac`])s[e]={near:a(e,ux,e,o[e]),nearHi:dx[e]===ux[e]?null:a(`${e}-hi`,dx,e,o[e]),far:a(`${e}-far`,fx,e,o[e])};let c=new ki(Xb(new la(1,1,1).translate(0,-.5,0),Yb.stone),i,r.length);c.name=`huts-foundation`,c.instanceMatrix.setUsage(Ue),c.count=0,c.frustumCulled=!1,n.add(c);let l=new Zt,u=new Ot,d=new U,f=new U,p=new U(0,1,0),m=new Set,h=1/0,g=1/0,_=[`near`,`nearHi`,`far`];function v(e){let t={rifugio:{near:0,nearHi:0,far:0},bivouac:{near:0,nearHi:0,far:0}},n=0;m.clear();let i=qb.value===1;for(let a of r){let r=Math.hypot(a.x-e.position.x,a.z-e.position.z),o=i&&s[a.kind].nearHi!==null,h=r>800?`far`:o?`nearHi`:`near`;if(u.setFromAxisAngle(p,a.yaw),d.set(a.x,a.y,a.z),f.setScalar(a.scale),l.compose(d,u,f),s[a.kind][h].setMatrixAt(t[a.kind][h],l),t[a.kind][h]+=1,h!==`far`){m.add(a.poi.id);let e=px[a.kind];f.set(e.w*a.scale,a.drop,e.d*a.scale),l.compose(d,u,f),c.setMatrixAt(n,l),n+=1}}for(let e of[`rifugio`,`bivouac`])for(let n of _){let r=s[e][n];r&&(r.count=t[e][n],r.instanceMatrix.needsUpdate=!0)}c.count=n,c.instanceMatrix.needsUpdate=!0}let y=null;function b(e){y=e,!(Math.hypot(e.position.x-h,e.position.z-g)<gx)&&(h=e.position.x,g=e.position.z,v(e))}function x(){y&&v(y)}function S(e){for(let t of r){t.yaw=vx(e,t.x,t.z);let n=px[t.kind],r=_x(e,t.x,t.z,n.w*t.scale,n.d*t.scale,t.yaw);t.y=r.y,t.drop=r.drop}y&&v(y)}return{group:n,update:b,applyDetail:x,alignToGround:S,hasBuilding:e=>m.has(e.id),placements:r,triangles:Object.fromEntries([[`rifugio`,s.rifugio.near],[`rifugioFar`,s.rifugio.far],[`bivouac`,s.bivouac.near],[`bivouacHi`,s.bivouac.nearHi],[`bivouacFar`,s.bivouac.far],[`foundation`,c]].filter(([,e])=>e).map(([e,t])=>[e,t.geometry.attributes.position.count/3]))}}var bx={iron:6513248,wood:9601129,bronze:15585958,stone:16777215,rock:11182742};function xx(e,t){e.deleteAttribute(`uv`);let n=e.index?e.toNonIndexed():e,r=n.attributes.position.count,i=new Float32Array(r*3),a=new G(t);for(let e=0;e<r;e+=1)i[e*3]=a.r,i[e*3+1]=a.g,i[e*3+2]=a.b;return n.setAttribute(`color`,new mr(i,3)),n}function Sx(e,t,n,r,i,a){let o=new la(e,t,n);return o.translate(r,i,a),o}function Cx(){let e=.14,t=[xx(Sx(1.45,.34,1.45,0,.17,0),bx.stone),xx(Sx(e,3.2,e,0,1.9500000000000002,0),bx.iron),xx(Sx(1.55,e,e*.9,0,2.654,0),bx.iron)];for(let e of[-1,1]){let n=new la(.5,.07,.07);n.rotateZ(e*Math.PI/4),n.translate(e*.28,2.4539999999999997,0),t.push(xx(n,bx.iron))}return t}function wx(){return[xx(Sx(1.15,.62,1.15,0,.31,0),bx.stone),xx(Sx(.8,.26,.8,0,.75,0),bx.stone),xx(new fa(.21,.4,1.18,8).translate(0,1.47,0),bx.bronze),xx(new fa(.155,.3,.46,8).translate(0,2.19,0),bx.bronze),xx(new to(.135,8,6).translate(0,2.47,0),bx.bronze),xx(new to(.1,6,5).translate(0,1.62,.26),bx.bronze)]}var Tx={cross:Cx,madonna:wx},Ex={cross:{w:1.7,d:1.7},madonna:{w:1.3,d:1.3}},Dx=[{poiId:`n1562997760`,poiName:`Granta Parey`,kind:`cross`},{poiId:`n1707240539`,poiName:`Madonna`,kind:`madonna`},{lat:45.5246603,lon:7.1890672,poiName:`Croce (45.5247N, 7.1891E)`,kind:`cross`}],Ox={Madonna:7};function kx({pois:e,sampleHeight:t}){let n=new En;n.name=`summit-monuments`;let r=new go({vertexColors:!0,roughness:.8,metalness:0,flatShading:!0});Ev(r);let i=new Map(e.map(e=>[e.id,e])),a=[],o=[];for(let e of Dx){let t=null;if(e.poiId){if(t=i.get(e.poiId),!t){o.push(`${e.poiName} (${e.poiId})`);continue}}else{let{x:n,z:r}=av(e.lat,e.lon);t={id:`${e.lat},${e.lon}`,name:e.poiName,local:{x:n,z:r},elevationM:null}}let s=new _i(Gb(Tx[e.kind]()),r);s.name=`monument-${e.kind}-${e.poiId}`,s.castShadow=!1,s.receiveShadow=!1,n.add(s);let c=new _i(xx(new la(1,1,1).translate(0,-.5,0),bx.rock),r);c.name=`monument-base-${e.poiId??e.poiName}`,n.add(c),a.push({...e,poi:t,mesh:s,base:c})}o.length&&console.warn(`Summit monuments with no POI: ${o.join(`, `)}`);function s(e,t,n,r,i,a){let o=Math.cos(a),s=Math.sin(a),c=1/0,l=-1/0;for(let[a,u]of[[-r/2,-i/2],[r/2,-i/2],[-r/2,i/2],[r/2,i/2]]){let r=e(t+a*o+u*s,n-a*s+u*o);Number.isFinite(r)&&(c=Math.min(c,r),l=Math.max(l,r))}if(!Number.isFinite(l))return null;let u=c+(l-c)*.35;return{y:u,drop:u-c+.8}}function c(e,t,n,r){let i={x:t,z:n,h:e(t,n)??-1/0};for(let a=-r;a<=r;a+=2)for(let o=-r;o<=r;o+=2){if(o*o+a*a>r*r)continue;let s=e(t+o,n+a);Number.isFinite(s)&&s>i.h&&(i={x:t+o,z:n+a,h:s})}return i}function l(e){for(let t of a){let{x:n,z:r}=t.poi.local,i=Ox[t.poiName];if(i){let a=c(e,n,r,i);t.movedM=Math.hypot(a.x-n,a.z-r),t.raisedM=a.h-(e(n,r)??a.h),n=a.x,r=a.z}let a=e(n,r);Number.isFinite(a)?t.mesh.position.set(n,a,r):Number.isFinite(t.poi.elevationM)?t.mesh.position.set(n,t.poi.elevationM,r):t.mesh.position.set(n,t.mesh.position.y,r);let o=(e(n+30,r)??0)-(e(n-30,r)??0),l=(e(n,r+30)??0)-(e(n,r-30)??0);t.mesh.rotation.y=Math.abs(o)<.001&&Math.abs(l)<.001?0:Math.atan2(-o,-l);let u=Ex[t.kind],d=s(e,n,r,u.w,u.d,t.mesh.rotation.y);d&&(t.mesh.position.y=d.y,t.base.position.set(n,d.y,r),t.base.rotation.y=t.mesh.rotation.y,t.base.scale.set(u.w,d.drop,u.d),t.drop=d.drop),t.y=t.mesh.position.y}}l(t);function u(){n.visible=qb.value===1}return u(),{group:n,applyDetail:u,alignToGround:l,monuments:a,missing:o,triangles:Object.fromEntries(a.map(e=>[e.poiName,e.mesh.geometry.attributes.position.count/3]))}}var Ax={value:0},jx=new G(867159),Mx=new G(5220553),Nx=new G(1858424),Px=new G(9425896),Fx=new G(14677243),Ix=8,Lx=3,Rx=3,zx=.8,Bx=8,Vx=4,Hx=5,Ux=6,Wx=`
...
`;function Gx({deep:e,shallow:t,flowing:n}){return new mo({transparent:!0,side:2,uniforms:{uTime:Ax,uColorDeep:{value:e},uColorShallow:{value:t},...xv.uniforms},vertexShader:`
      #include <common>
      #include <logdepthbuf_pars_vertex>
    ...
    `})}function Kx(){return new mo({transparent:!0,side:2,uniforms:{uTime:Ax,uColor:{value:Fx},...xv.uniforms},vertexShader:`
      #include <common>
      #include <logdepthbuf_pars_vertex>
    ...
    `,fragmentShader:`
      ...
      void main() {
        ...
        float flow = fract(vFlow / ${Ux}.0 - uTime * 1.1 + strand * 0.55);
    ...
    `})}function qx(e){let t=e.slice(0,-1).map(([e,t])=>new H(e,t));if(t.length<3)return null;try{let e=Ya.triangulateShape(t,[]);return e.length?{pts:t,tris:e}:null}catch{return null}}function Jx(e){let t=[],n=[],r=0,i=0;for(let a of e){let e=qx(a.ring);if(!e){i++;continue}for(let n of e.pts)t.push(n.x,a.waterLevelM,n.y);for(let[t,i,a]of e.tris)n.push(r+t,r+i,r+a);r+=e.pts.length}if(i&&console.warn(`water.js: skipped ${i}/${e.length} lake polygon(s) that failed to triangulate.`),!t.length)return null;let a=new kr;a.setAttribute(`position`,new _r(t,3)),a.setIndex(n),a.computeVertexNormals();let o=new _i(a,Gx({deep:jx,shallow:Mx,flowing:!1}));return o.name=`water-lakes`,o}function Yx(e,t,n,r,i,a,o){let s=e.length;if(s<2)return;let c=0,l=o.value;for(let o=0;o<s;o++){let[u,d,f]=e[o],p=e[Math.max(0,o-1)],m=e[Math.min(s-1,o+1)],h=m[0]-p[0],g=m[2]-p[2],_=Math.hypot(h,g)||1,v=-g/_,y=h/_,b=t(o/(s-1))/2;r.push(u+v*b,d+n,f+y*b),r.push(u-v*b,d+n,f-y*b);let x=o/(s-1);if(i.push(x,0,x,1),o>0&&(c+=Math.hypot(u-e[o-1][0],f-e[o-1][2])),o<s-1){let e=l+o*2,t=e+1,n=l+(o+1)*2,r=n+1;a.push(e,t,n,t,r,n)}}o.value+=s*2}var Xx=10;function Zx(e,{widthM:t,heightOffsetM:n,name:r}){let i=[],a=[],o=[],s={value:0};for(let r of e??[])Yx(nb(r.line,Xx),()=>t,n,i,a,o,s);if(!i.length)return null;let c=new kr;c.setAttribute(`position`,new _r(i,3)),c.setAttribute(`uv`,new _r(a,2)),c.setIndex(o),c.computeVertexNormals();let l=new _i(c,Gx({deep:Nx,shallow:Px,flowing:!0}));return l.name=r,l}function Qx(e,t,n,r,i,a,o,s){let c=e.length;if(c<2)return;let l=[0];for(let t=1;t<c;t++){let[n,,r]=e[t-1],[i,,a]=e[t];l.push(l[t-1]+Math.hypot(i-n,a-r))}let u=l[c-1]||1,d=s.value;for(let o=0;o<c;o++){let[s,d,f]=e[o],p=e[Math.max(0,o-1)],m=e[Math.min(c-1,o+1)],h=m[0]-p[0],g=m[2]-p[2],_=Math.hypot(h,g)||1,v=-g/_,y=h/_,b=Math.max(0,(p[1]-m[1])/_),x=Math.min(Vx,b*Hx),S=l[o]/u,C=(t+(n-t)*S)/2;for(let e=0;e<=Bx;e++){let t=e/Bx,n=t*2-1,c=1-n*n;r.push(s+v*n*C,d+x*c,f+y*n*C),i.push(t,S),a.push(l[o])}}for(let e=0;e<c-1;e++)for(let t=0;t<Bx;t++){let n=d+e*9+t,r=n+1,i=n+9,a=i+1;o.push(n,i,r,r,i,a)}s.value+=c*9}function $x(e){let t=[],n=[],r=[],i=[],a={value:0},o=[],s=eS();for(let c of e){Qx(c.centerline,c.widthTopM,c.widthBottomM,t,n,r,i,a);let e=c.centerline[c.centerline.length-1],l=new Yr(new Fr({map:s,transparent:!0,opacity:.55,depthWrite:!1,fog:!1}));l.position.set(e[0],e[1]+8,e[2]);let u=20+Math.min(60,c.dropM)*.6;l.scale.set(u,u,1),l.name=`mist-${c.name}`,o.push({sprite:l,baseScale:u,phase:Math.random()*Math.PI*2})}let c=new En;if(c.name=`waterfalls`,t.length){let e=new kr;e.setAttribute(`position`,new _r(t,3)),e.setAttribute(`uv`,new _r(n,2)),e.setAttribute(`aFlow`,new _r(r,1)),e.setIndex(i),e.computeVertexNormals();let a=new _i(e,Kx());a.name=`waterfall-ribbons`,c.add(a)}for(let{sprite:e}of o)c.add(e);return{group:c,mistSprites:o}}function eS(){let e=document.createElement(`canvas`);e.width=128,e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);return n.addColorStop(0,`rgba(255,255,255,0.9)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,128,128),new aa(e)}async function tS(e=`./data`){let t=await fetch(`${e}/water.json`).then(e=>e.json()),n=new En;n.name=`water`;let r=Jx(t.lakes);r&&n.add(r);let i=Zx(t.rivers,{widthM:Ix,heightOffsetM:Lx,name:`water-rivers`});i&&n.add(i);let a=Zx(t.streams,{widthM:Rx,heightOffsetM:zx,name:`water-streams`});a&&n.add(a);let{group:o,mistSprites:s}=$x(t.waterfalls);n.add(o);function c(e){Ax.value=e;for(let{sprite:t,baseScale:n,phase:r}of s){let i=n*(1+.12*Math.sin(e*.7+r));t.scale.set(i,i,1)}}function l(e){for(let t of n.children){let n=t.name===`water-rivers`?Lx:t.name===`water-streams`?zx:null;if(n===null)continue;let r=t.geometry?.getAttribute(`position`);if(!r)continue;let i=r.array;for(let t=0;t<i.length;t+=3){let r=e(i[t],i[t+2]);Number.isFinite(r)&&(i[t+1]=r+n)}r.needsUpdate=!0,t.geometry.computeBoundingSphere()}}return{group:n,manifest:t,update:c,alignToGround:l}}var nS=16777215,rS=2,iS=.5,aS=8;async function oS(e=`./data`){let t=await fetch(`${e}/roads.json`).then(e=>e.json()),n=[];for(let e of t.roads){let t=nb(e.line,aS);for(let e=1;e<t.length;e++){let[r,i,a]=t[e-1],[o,s,c]=t[e];n.push(r,i+iS,a,o,s+iS,c)}}let r=new Float32Array(n),i=new jy;i.setPositions(r);let a=Tv(new My({color:nS,linewidth:rS,resolution:new H(window.innerWidth,window.innerHeight)})),o=new Zy(i,a);o.name=`roads-track`;let s=new En;s.name=`roads`,s.add(o);function c(e){for(let t=0;t<r.length;t+=3)r[t+1]=e(r[t],r[t+2])+iS;i.attributes.instanceStart.data.needsUpdate=!0,i.computeBoundingSphere()}function l(e,t){a.resolution.set(e,t)}return{group:s,manifest:t,alignToGround:c,setResolution:l}}var sS=1e3,cS=.45,lS=440,uS=300,dS=1600,fS=2200,pS=.55,mS=.16,hS=.26,gS=1.5,_S=7112545,vS=.3,yS=.85;function bS(e){let t=e.toPrecision(12);return t.includes(`.`)||t.includes(`e`)?t:`${t}.0`}function xS(e,t,n){if(!e.includes(t))throw Error(`vegetation.js: shader marker not found: ${t}`);return e.replace(t,n)}function SS(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}var CS=null;function wS(){if(CS)return CS;let e=Math.round(sS/6),t=new Float32Array(e*e*2),n=SS(2654435769);for(let r=0;r<e;r++)for(let i=0;i<e;i++){let a=r*e+i;t[a*2]=(i+.5+(n()-.5)*2*cS)*6,t[a*2+1]=(r+.5+(n()-.5)*2*cS)*6}return CS={offsets:t,perSide:e},CS}function TS(e,t,n,r){let{offsets:i,perSide:a}=wS(),o=e=>(e%sS+sS)%sS,s=Math.floor(o(e)/6),c=Math.floor(o(t)/6),l=null,u=1/0;for(let o=-1;o<=1;o++)for(let d=-1;d<=1;d++){let f=((s+d)%a+a)%a,p=((c+o)%a+a)%a*a+f,m=i[p*2],h=i[p*2+1],g=m+Math.floor((n-m)/sS+.5)*sS,_=h+Math.floor((r-h)/sS+.5)*sS,v=(g-e)**2+(_-t)**2;v<u&&(u=v,l={x:g,z:_,index:p})}return{...l,distanceM:Math.sqrt(u)}}var ES=3,DS=7,OS=150,kS=8,AS=Math.ceil(Math.PI*158**2/6**2*1.2);function jS(){let e=[],t=new fa(.028,.052,1,5,1);t.translate(0,.5,0),e.push(t);let n=.12;for(let t=0;t<ES;t++){let r=t/ES,i=n+(1-n)*r,a=(1-n)/ES*1.85,o=new pa((1-r)*.98+.06,a,DS,1,!0);o.translate(0,i+a/2,0),e.push(o)}return e}function MS({manifest:e,heightTexture:t}){let{xmin:n,ymin:r,xmax:i,ymax:a}=e.bboxCrsUnits,{min:o,max:s}=e.elevationRangeM,{y:c}=e.resolutionMPerPx,l=i-n,u=a-r,{offsets:d,perSide:f}=wS(),p=f*f,m=new pa(1,1,7,1,!0);m.translate(0,.5,0);let h=new xi(d,2);function g(e,t,n){let r=new is;return r.index=e.index,r.setAttribute(`position`,e.attributes.position),r.setAttribute(`normal`,e.attributes.normal),r.setAttribute(`uv`,e.attributes.uv),r.setAttribute(`aOffset`,t),r.instanceCount=n,r}let _=new xi(new Float32Array(AS*2),2);_.setUsage(Ue);let v=g(m,h,p),y=g(Gb(jS()),_,0),b=new go({color:_S,roughness:.95,metalness:0,flatShading:!0}),x=`
...
${Vv()}
    ...
    float vegElevation( vec2 uv, vec2 wxz ) {
      ...
      return ( ( s.r * 256.0 + s.g ) / 257.0 ) * ${bS(s-o)} + ${bS(o)}
           + heightTierM( wxz );
    }
  ...
  `,S=({wrapped:e})=>`
    ...
    vec2 slot = aOffset + floor( ( cameraPosition.xz - aOffset ) / ${bS(sS)} + 0.5 ) * ${bS(sS)};`:`vec2 slot = aOffset; // already the world position, written per refill by the CPU`}
    vec2 vegCell = floor( slot / ${bS(6)} );
    vec2 uv = vegUv( slot );
    ...
    float near = 1.0 - smoothstep( ${bS(uS)}, ${bS(lS)}, dist );
    ...
    near *= 1.0 - step( ${bS(OS)}, dist );`}

    float elev = vegElevation( uv, slot );
    float stunt = mix( 1.0, ${bS(pS)},
                       smoothstep( ${bS(dS)}, ${bS(fS)}, elev ) );
    float treeH = mix( ${bS(5)}, ${bS(16)}, vegHash( vegCell + 19.7 ) )
                * stunt * exists * near;
    float treeR = treeH * mix( ${bS(mS)}, ${bS(hS)}, vegHash( vegCell + 41.3 ) );
    ...
    float dv = ${bS(c)} / ${bS(u)};
    float gradZ = ( vegElevation( uv + vec2( 0.0, dv ), slot - vec2( 0.0, ${bS(c)} ) )
                  - vegElevation( uv - vec2( 0.0, dv ), slot + vec2( 0.0, ${bS(c)} ) ) )
                / ${bS(2*c)};
    ...
    vec3 transformed = vec3(
      ...
      position.y * treeH + elev - ${bS(gS)},
      position.z * treeR + slot.y
    );
  `,C={value:0};function w(e){return n=>{n.uniforms.uHeightMap={value:t},n.uniforms.uHeightTier=pv,n.uniforms.uHeightTierRect=mv,n.uniforms.uHeightTierMix=hv,n.uniforms.uForestMask=Dv,n.uniforms.uSnow=Fv,e&&(n.uniforms.uNearHole=C);let r=n.vertexShader;r=xS(r,`#include <common>`,`#include <common>\n${e?`uniform float uNearHole;
`:``}${x}`),r=xS(r,`#include <begin_vertex>`,S({wrapped:e})),n.vertexShader=r;let i=n.fragmentShader;i=xS(i,`#include <common>`,`#include <common>
varying float vTreeTint;
varying float vTreeSnow;`),i=xS(i,`#include <map_fragment>`,`#include <map_fragment>
  diffuseColor.rgb *= vTreeTint;
  diffuseColor.rgb = mix( diffuseColor.rgb, ${Bv()}, vTreeSnow );`),n.fragmentShader=i}}b.onBeforeCompile=w(!0),b.customProgramCacheKey=()=>`pngp-veg-wrapped`,Ev(b);let T=b.clone();T.onBeforeCompile=w(!1),T.customProgramCacheKey=()=>`pngp-veg-nearwindow`,Ev(T);let E=new En;E.name=`vegetation-lod`;let D=new _i(v,b);D.name=`vegetation`;let O=new _i(y,T);O.name=`vegetation-high`;for(let e of[D,O])e.frustumCulled=!1,E.add(e);O.visible=!1;let k=y.index.count/3,A=1/0,ee=1/0,j=0,M=!1;function te(e,t,n){if(!Number.isFinite(e)||!Number.isFinite(t)||!n&&Math.hypot(e-A,t-ee)<kS)return;A=e,ee=t;let r=_.array,i=0;for(let n=0;n<p;n++){let a=d[n*2],o=d[n*2+1],s=a+Math.floor((e-a)/sS+.5)*sS,c=o+Math.floor((t-o)/sS+.5)*sS,l=s-e,u=c-t;if(!(l*l+u*u>24964)){if(i>=AS){M=!0;break}r[i*2]=s,r[i*2+1]=c,i++}}j=i,_.needsUpdate=!0,y.instanceCount=i}return{object:E,applyDetail(){let e=qb.value===1;C.value=e?OS:0,O.visible=e,D.visible=!0,A=1/0,ee=1/0},update(e){qb.value===1&&te(e.position.x,e.position.z,!1)},stats:{instances:p,trianglesPerTree:7,trianglesPerTreeHi:k,windowM:sS,spacingM:6,visibleM:lS,hiNearM:OS,hiCapacity:AS},nearInfo:()=>({count:j,capacity:AS,overflowed:M})}}var NS={value:null};function PS(){let e=new bi(new Uint8Array([0]),1,1,D,l);return e.needsUpdate=!0,e}NS.value=PS();function FS({manifest:e,texture:t}){let{width:n,height:r}=e.dimensions,{xmin:i,ymin:a,xmax:o,ymax:s}=e.bboxCrsUnits,c=o-i,l=s-a,u=document.createElement(`canvas`);u.width=n,u.height=r;let d=u.getContext(`2d`);if(!d)return()=>0;d.drawImage(t.image,0,0,n,r);let f=d.getImageData(0,0,n,r).data,p=new Uint8Array(n*r);for(let e=0;e<p.length;e++)p[e]=f[e*4];return function(e,t){let i=Math.floor((e+c/2)/c*n),a=Math.floor((t+l/2)/l*r);return i<0||i>=n||a<0||a>=r?0:p[a*n+i]/255}}async function IS(e=`./data`){let n=await fetch(`${e}/landcover.json`).then(e=>e.json()),r=await new Bo().loadAsync(`${e}/${n.mask.file.name}`);return r.colorSpace=``,r.wrapS=t,r.wrapT=t,r.magFilter=o,r.minFilter=o,r.generateMipmaps=!1,r.needsUpdate=!0,NS.value=r,{manifest:n,texture:r}}var LS={windowM:54,spacingM:.26,jitter:.45,visibleM:25,fadeStartM:15,seed:1374498683},RS={windowM:130,spacingM:1.1,jitter:.42,visibleM:60,fadeStartM:40,seed:795779357},zS={windowM:130,spacingM:20,jitter:.45,visibleM:60,fadeStartM:45,seed:2050080863},BS=.055,VS=.45,HS=.1,US=.28,WS=1400,GS=2700,KS=.55,qS=.05,JS=.26,YS=.55,XS=1.6,ZS=.8,QS=1.9,$S=.6,eC=1.05,tC=53.9,nC=.12,rC=0,iC=1,aC=.62,oC=[.55,.78],sC=[.88,1.16,.72],cC=[1.02,1,.97],lC=9676906,uC=1,dC=1,fC=.9,pC=[.83,.56],mC=9,hC=1.7,gC=.075,_C=2.2,vC=.55,yC=1.45,bC=[-.55,.84],xC=23,SC=.61,CC=.45,wC={value:0},TC={value:0},EC={value:1};function X(e){let t=e.toPrecision(12);return t.includes(`.`)||t.includes(`e`)?t:`${t}.0`}function DC(e,t,n){if(!e.includes(t))throw Error(`groundcover.js: shader marker not found: ${t}`);return e.replace(t,n)}function OC(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function kC({windowM:e,spacingM:t,jitter:n,seed:r}){let i=Math.round(e/t),a=e/i,o=i*i,s=new Float32Array(o*2),c=OC(r);for(let e=0;e<i;e++)for(let t=0;t<i;t++){let r=e*i+t;s[r*2]=(t+.5+(c()-.5)*2*n)*a,s[r*2+1]=(e+.5+(c()-.5)*2*n)*a}for(let e=o-1;e>0;e--){let t=Math.floor(c()*(e+1));for(let n of[0,1]){let r=s[e*2+n];s[e*2+n]=s[t*2+n],s[t*2+n]=r}}return{offsets:s,perSide:i,count:o,pitchM:a}}function AC(){let e=new Float32Array(72),t=new Float32Array(72);for(let n=0;n<8;n++){let r=n*2.39996,i=Math.cos(r),a=Math.sin(r),o=n*9;e[o+0]=-a*BS,e[o+1]=0,e[o+2]=i*BS,e[o+3]=a*BS,e[o+4]=0,e[o+5]=-i*BS,e[o+6]=0,e[o+7]=1,e[o+8]=0;for(let e=0;e<3;e++){let r=(n*3+e)*3;t[r]=e===2?i*VS:0,t[r+1]=e===2?a*VS:0,t[r+2]=n*1.7}}let n=new kr;return n.setAttribute(`position`,new mr(e,3)),n.setAttribute(`aBlade`,new mr(t,3)),n.setAttribute(`normal`,new mr(new Float32Array(e.length),3)),n}function jC(){let e=new $a(1,0),t=e.attributes.position,n=new Float32Array(t.count*3);for(let e=0;e<t.count;e++)n[e*3]=t.getX(e),n[e*3+1]=t.getY(e),n[e*3+2]=t.getZ(e);if(t.count!==24)throw Error(`stoneGeometry: ${t.count/3} triangles, STONE_TRIANGLES says 8`);let r=new kr;return r.setAttribute(`position`,new mr(n,3)),r.setAttribute(`aBlade`,new mr(new Float32Array(t.count*3),3)),r.setAttribute(`normal`,new mr(new Float32Array(n.length),3)),e.dispose(),r}function MC(){let e=OC(1527370047),t=t=>1+(e()-.5)*2*t,n=[],r=[];for(let i=0;i<6;i++){let a=(i+(e()-.5)*.55)/6*Math.PI*2,o=.46*t(.3);n.push([Math.cos(a)*o,.5+e()*.5,Math.sin(a)*o]);let s=(i+.5+(e()-.5)*.55)/6*Math.PI*2,c=t(.22);r.push([Math.cos(s)*c,(e()-.5)*.3,Math.sin(s)*c])}let i=Math.max(...n.map(e=>e[1]));for(let e of n)e[1]/=i;let a=[];for(let e=1;e<5;e++)a.push(n[0],n[e],n[e+1]);for(let e=0;e<6;e++){let t=(e+1)%6;a.push(n[e],n[t],r[e]),a.push(r[e],r[t],n[t])}let o=[0,-1,0];for(let e=0;e<6;e++)a.push(r[e],r[(e+1)%6],o);if(a.length!==66)throw Error(`boulderGeometry: ${a.length/3} triangles, BOULDER_TRIANGLES says 22`);let s=new Float32Array(a.length*3);for(let e=0;e<a.length;e++)s[e*3]=a[e][0],s[e*3+1]=a[e][1],s[e*3+2]=a[e][2];let c=new kr;return c.setAttribute(`position`,new mr(s,3)),c.setAttribute(`aBlade`,new mr(new Float32Array(a.length*3),3)),c.setAttribute(`normal`,new mr(new Float32Array(s.length),3)),c}function NC({kind:e,layer:t,manifest:n,heightTexture:r}){let{xmin:i,ymin:a,xmax:o,ymax:s}=n.bboxCrsUnits,{min:c,max:l}=n.elevationRangeM,u=o-i,d=s-a,f=e===`grass`,p=e===`boulder`,{offsets:m,count:h,pitchM:g}=kC(t),_=f?AC():p?MC():jC(),v=new is;v.setAttribute(`position`,_.attributes.position),v.setAttribute(`normal`,_.attributes.normal),v.setAttribute(`aBlade`,_.attributes.aBlade),v.setAttribute(`aOffset`,new xi(m,2)),v.instanceCount=h;let y=new go({color:16777215,roughness:.94,metalness:0,flatShading:!0,side:2}),b=`
    attribute vec2 aOffset;
...
${f?`    float stunt = mix( 1.0, ${X(KS)},
                       smoothstep( ${X(WS)}, ${X(GS)}, h ) );
    float alive = exists * near;
    // Buried, not whitened - see GRASS_BURY.
    float height = mix( ${X(HS)}, ${X(US)}, coverHash( coverCell + 13.1 ) )
                 * stunt * alive * ( 1.0 - snow * ${X(uC)} );
    ...
    vCoverSnow = 0.0;
    vec3 tint = vec3( ${sC.map(X).join(`, `)} );
    float sway = ${X(gC)};`:`    // The two mineral layers run the same code on different constants: cobbles
    ...
    float height = mix( ${X(p?YS:qS)}, ${X(p?XS:JS)},
                        coverHash( coverCell + 13.1 ) )
                 * exists * near * ( 1.0 - snow * ${X(dC)} );
    ...
    float radius = height * mix( ${X(p?$S:ZS)}, ${X(p?eC:QS)},
    ...
    float yaw = coverHash( coverCell + ${X(tC)} ) * ${X(Math.PI*2)};
    float cy = cos( yaw ), sy = sin( yaw );
    mat2 yawM = mat2( cy, sy, -sy, cy );
    vCoverSnow = snow * ${X(fC)};
    vec3 tint = vec3( ${cC.map(X).join(`, `)} );
    float sway = ${X(0)};`}
    ...
    vec3 photo = mix( ${(()=>{let e=new G(lC);return`vec3( ${X(e.r)}, ${X(e.g)}, ${X(e.b)} )`})()}, basemapAlbedo( uv, 0.0 ), uBasemapMix );
...
${f?`    // Three per-tuft randomisations on top of it (2026-08-13, the user asked for
    ...
    // replacing it.
    float lag = ( coverHash( coverCell + 3.3 ) - 0.5 ) * ${X(_C)};
    float gust = mix( ${X(vC)}, ${X(yC)}, coverHash( coverCell + 47.9 ) );
    float wave = sin( dot( slot, vec2( ${X(pC[0])}, ${X(pC[1])} ) ) * ${X(2*Math.PI/mC)}
                    - uCoverTime * ${X(hC*2*Math.PI)} + aBlade.z + lag );
    float cross = sin( dot( slot, vec2( ${X(bC[0])}, ${X(bC[1])} ) ) * ${X(2*Math.PI/xC)}
                     - uCoverTime * ${X(SC*2*Math.PI)} + lag );
    vec2 bend = ( vec2( ${X(pC[0])}, ${X(pC[1])} ) * ( wave * 0.5 + 0.6 )
                + vec2( ${X(bC[0])}, ${X(bC[1])} ) * cross * ${X(CC)} )
    ...
    float wave = sin( dot( slot, vec2( ${X(pC[0])}, ${X(pC[1])} ) ) * ${X(2*Math.PI/mC)}
                    - uCoverTime * ${X(hC*2*Math.PI)} + aBlade.z );
    vec2 bend = vec2( ${X(pC[0])}, ${X(pC[1])} ) * ( wave * 0.5 + 0.6 )
    ...
    vec3 transformed = vec3(
      ...
      position.y * height + h - height * ${X(f?nC:rC)},
      local.y + aBlade.y * height + slot.y + bend.y
    );
  `;y.onBeforeCompile=e=>{e.uniforms.uHeightMap={value:r},e.uniforms.uCoverMask=NS,e.uniforms.uGlacierMask=Mv,f||(e.uniforms.uForestMask=Dv),e.uniforms.uGroundSegments=gv,e.uniforms.uHeightTier=pv,e.uniforms.uHeightTierRect=mv,e.uniforms.uHeightTierMix=hv,e.uniforms.uSnow=Fv,e.uniforms.uWind=wC,e.uniforms.uCoverTime=TC,e.uniforms.uBasemap=Wv,e.uniforms.uBasemapMix=Gv,e.uniforms.uBasemapScale=Kv;let t=e.vertexShader;t=DC(t,`#include <common>`,`#include <common>\n${b}`),t=DC(t,`#include <begin_vertex>`,x),e.vertexShader=t;let n=e.fragmentShader;n=DC(n,`#include <common>`,`#include <common>
varying vec3 vCoverAlbedo;
varying float vCoverSnow;`),n=DC(n,`#include <map_fragment>`,`#include <map_fragment>
  diffuseColor.rgb *= vCoverAlbedo;
  diffuseColor.rgb = mix( diffuseColor.rgb, ${Bv()}, vCoverSnow );`),e.fragmentShader=n},Ev(y),y.customProgramCacheKey=()=>`pngp-groundcover-${e}`;let S=new _i(v,y);return S.name=`groundcover-${e}`,S.frustumCulled=!1,{kind:e,mesh:S,count:h,geometry:v,pitchM:g}}function PC({manifest:e,heightTexture:t}){let n=new En;n.name=`groundcover`;let r=[NC({kind:`grass`,layer:LS,manifest:e,heightTexture:t}),NC({kind:`scree`,layer:RS,manifest:e,heightTexture:t}),NC({kind:`boulder`,layer:zS,manifest:e,heightTexture:t})];for(let e of r)n.add(e.mesh);function i(){let e=Math.min(1,Math.max(0,EC.value));for(let t of r)t.geometry.instanceCount=Math.round(t.count*e),t.mesh.visible=t.geometry.instanceCount>0}return i(),{object:n,applyDensity:i,layers:r,stats:{grass:{instances:r[0].count,trianglesPerInstance:8,windowM:LS.windowM,spacingM:r[0].pitchM,visibleM:LS.visibleM},scree:{instances:r[1].count,trianglesPerInstance:8,windowM:RS.windowM,spacingM:r[1].pitchM,visibleM:RS.visibleM},boulder:{instances:r[2].count,trianglesPerInstance:22,windowM:zS.windowM,spacingM:r[2].pitchM,visibleM:zS.visibleM},trianglesAtFullDensity:r[0].count*8+r[1].count*8+r[2].count*22}}}var FC=2,IC=.3,LC=4,RC=260,zC=6,BC=44,VC=-.35,HC=.45,UC=.026,WC=.041,GC=2.6,KC=16250090,qC=14205532;function JC(e,t){let n=(Math.imul(e|0,668265261)^Math.imul(t|0,374761393)^2654435769)>>>0;return()=>{n=n+1831565813>>>0;let e=Math.imul(n^n>>>15,1|n);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}var YC=9,XC=.17,ZC=7,QC=6,$C=5,ew=9278064,tw=13617576;function nw(){let e=[],t=[],n=new G(KC),r=new G(tw),i=new G(qC),a=new G(ew),o=(n,r,i,a,o,s)=>{e.push(...n,...r,...i),t.push(a.r,a.g,a.b,o.r,o.g,o.b,s.r,s.g,s.b)},s=(e,t,n,r,i,a,s,c)=>{o(e,t,n,i,a,s),o(e,n,r,i,s,c)},c=e=>({y:e*GC,r:.085*(1-.45*e),lean:.16*e*e}),l=e=>{let{y:t,r:n,lean:r}=c(e),i=[];for(let e=0;e<QC;e++){let a=e/QC*Math.PI*2;i.push([Math.cos(a)*n+r,t,Math.sin(a)*n])}return i},u=[l(0),l(.5),l(1)];for(let e=0;e<u.length-1;e++)for(let t=0;t<QC;t++){let n=(t+1)%QC;s(u[e][t],u[e][n],u[e+1][n],u[e+1][t],a,a,a,a)}let d=c(1);for(let e=0;e<$C;e++){let t=e*2.39996,n=.18+e/$C*.55,{y:r,lean:i}=c(n),l=Math.cos(t),u=Math.sin(t),d=.55-n*.18,f=[l*.06+i,r,u*.06],p=.055,m=-u*p,h=l*p,g=[l*d*.55+i,r+d*.35,u*d*.55],_=[l*d+i,r+d*.3,u*d];s([f[0]+m,f[1],f[2]+h],[f[0]-m,f[1],f[2]-h],[g[0]-m*.8,g[1],g[2]-h*.8],[g[0]+m*.8,g[1],g[2]+h*.8],a,a,a,a),o([g[0]+m*.8,g[1],g[2]+h*.8],[g[0]-m*.8,g[1],g[2]-h*.8],_,a,a,a)}let f=[0,.35,.72,1],p=[.11,.17,.11,0],m=[.05,.11,.06,-.07];for(let e=0;e<YC;e++){let t=(e+e%2*.12)/YC*Math.PI*2,i=Math.cos(t),a=Math.sin(t),c=-a,l=i,u=e=>{let t=XC+f[e]*(1-XC);return{cx:i*t+d.lean,cy:d.y+m[e],cz:a*t,w:p[e]}},h=(e,t)=>{let n=u(e);return[n.cx+c*n.w*t,n.cy,n.cz+l*n.w*t]},g=e=>e===0?r:n;for(let e=0;e<2;e++)s(h(e,1),h(e,-1),h(e+1,-1),h(e+1,1),g(e),g(e),g(e+1),g(e+1));let _=u(3);o(h(2,1),h(2,-1),[_.cx,_.cy,_.cz],n,n,n)}let h=new Qa(1,0),g=h.attributes.position;for(let e=0;e<ZC;e++){let t=e===0,n=(e-1)/(ZC-1)*Math.PI*2+.4,r=t?0:.135,a=t?.085:.07,s=Math.cos(n)*r+d.lean,c=Math.sin(n)*r,l=d.y+(t?.115:.095);for(let e=0;e<g.count;e+=3){let t=t=>[g.getX(e+t)*a+s,g.getY(e+t)*a*.85+l,g.getZ(e+t)*a+c];o(t(0),t(1),t(2),i,i,i)}}h.dispose();let _=new kr;return _.setAttribute(`position`,new _r(e,3)),_.setAttribute(`color`,new _r(t,3)),_.computeVertexNormals(),_}function rw({sampleGroundHeight:e,coverAt:t,iceAt:n=()=>0}){let r=nw(),i=new go({vertexColors:!0,roughness:.95,metalness:0,flatShading:!0,side:2});Ev(i);let a=new ki(r,i,RC);a.name=`edelweiss`,a.count=0,a.frustumCulled=!1,a.instanceMatrix.setUsage(Ue);let o=new Map,s=new Set,c=new Zt,l=new Ot,u=new U,d=new U,f=new U(0,1,0);function p(t,n){let r=e(t,n);if(!Number.isFinite(r))return null;let i=e(t+8,n)-e(t-8,n),a=e(t,n+8)-e(t,n-8),o=i/16,s=a/16,c=Math.hypot(o,s),l=1/Math.sqrt(c*c+1);return{elevM:r,slopeDeg:Math.atan(c)*180/Math.PI,normalZ:-s*l}}function m(r,i){let a=`${r}:${i}`;if(o.has(a))return o.get(a);let s=JC(r,i),c=s(),l=(r+s())*320,u=(i+s())*320,d=s(),f=LC+Math.floor(s()*8),m=null;if(c<.17){let r=p(l,u),i=t(l,u),o=n(l,u);if(r!==null&&r.elevM>=1850&&r.elevM<=2980&&o<.15&&i>=.04&&i<=.62&&r.slopeDeg>=zC&&r.slopeDeg<=BC&&r.normalZ>=VC){let t=[];for(let n=0;n<f;n++){let n=s()*Math.PI*2,r=Math.sqrt(s())*IC*(.5+d*.5),i=l+Math.cos(n)*r,a=u+Math.sin(n)*r,o=e(i,a);if(!Number.isFinite(o))continue;let c=UC+s()*(WC-UC);t.push({x:i,y:o,z:a,rosette:c,stem:c*GC,yaw:s()*Math.PI*2,tiltX:(s()-.5)*.5,tiltZ:(s()-.5)*.5})}t.length&&(m={key:a,x:l,z:u,elevM:r.elevM,normalZ:r.normalZ,flowers:t})}}return o.set(a,m),m}let h={nearestM:null,nearestElevM:null,foundCount:0,justFound:!1,drawn:0,cellsTested:0};function g(e){let t=e.position.x,n=e.position.z,r=Math.floor(t/320),i=Math.floor(n/320),p=0,g=1/0,_=null;h.justFound=!1;for(let e=-2;e<=FC;e++)for(let o=-2;o<=FC;o++){let v=m(r+o,i+e);if(!v||Uv({elevM:v.elevM,aspectZ:v.normalZ,level:Fv.value})>HC)continue;let y=(v.x-t)**2+(v.z-n)**2;y<g&&(g=y,_=v),y<36&&!s.has(v.key)&&(s.add(v.key),h.foundCount=s.size,h.justFound=!0);for(let e of v.flowers){if(p>=RC)break;d.set(e.x,e.y,e.z),l.setFromAxisAngle(f,e.yaw);let t=new Ot().setFromEuler(new cn(e.tiltX,0,e.tiltZ));l.multiply(t),u.set(e.rosette,e.rosette,e.rosette),c.compose(d,l,u),a.setMatrixAt(p,c),p++}}a.count=p,p&&(a.instanceMatrix.needsUpdate=!0),h.drawn=p,h.cellsTested=o.size;let v=_?Math.sqrt(g):null;h.nearestM=v!==null&&v<=90?v:null,h.nearestElevM=h.nearestM===null?null:_.elevM}return{object:a,update:g,diag:h,patchFor:m,findNearestPatch(e,t,n=12){let r=null,i=1/0,a=Math.floor(e/320),o=Math.floor(t/320);for(let s=-n;s<=n;s++)for(let c=-n;c<=n;c++){let n=m(a+c,o+s);if(!n)continue;let l=(n.x-e)**2+(n.z-t)**2;l<i&&(i=l,r=n)}return r?{...r,distanceM:Math.sqrt(i)}:null}}}var iw=Math.PI*2,Z={ibex:9734522,horn:7498335,chamois:10584157,marmot:11837054,fox:13665351,squirrel:11894618,stocking:6511442,bib:16776416},aw=50,ow=1.5,sw=.42,cw=.2,lw=.04,uw=[{name:`ibex`,orientBaseM:1.5,reaction:`flee`,salt:433,cellM:600,presence:.5,herdMin:4,herdMax:9,spreadM:22,wanderM:14,speedMps:.65,fleeMul:2.2,alertM:45,grazeS:9,strideM:.9,turnRate:1.6,visibleM:480,fadeStartM:380,scaleMin:.9,scaleMax:1.15,capacity:64,habitat:{elevMin:2e3,elevMax:3400,slopeMin:18,slopeMax:58,canopyMax:.18}},{name:`chamois`,orientBaseM:1.2,reaction:`flee`,salt:706,cellM:500,presence:.45,herdMin:3,herdMax:7,spreadM:18,wanderM:12,speedMps:.8,fleeMul:2.6,alertM:55,grazeS:7,strideM:.75,turnRate:1.9,visibleM:430,fadeStartM:330,scaleMin:.85,scaleMax:1.05,capacity:56,habitat:{elevMin:1100,elevMax:2700,slopeMin:12,slopeMax:48,canopyMin:.02,canopyMax:.7}},{name:`marmot`,orientBaseM:.6,reaction:`flee`,salt:979,cellM:240,presence:.5,herdMin:2,herdMax:5,spreadM:9,wanderM:7,speedMps:1.1,fleeMul:3.2,alertM:25,grazeS:5,strideM:.32,turnRate:3.2,visibleM:230,fadeStartM:170,scaleMin:.85,scaleMax:1.1,capacity:64,habitat:{elevMin:1500,elevMax:2900,slopeMin:0,slopeMax:26,canopyMax:.28}},{name:`fox`,orientBaseM:1,salt:1252,reaction:`curious`,cellM:900,presence:.35,herdMin:1,herdMax:2,spreadM:30,wanderM:26,speedMps:1.1,grazeS:5,strideM:.7,turnRate:2.4,visibleM:380,fadeStartM:300,scaleMin:.9,scaleMax:1.1,capacity:24,curiousM:130,standoffM:7,boldChance:.55,approachMul:1.7,escapeMul:4.5,fleeMul:2.2,alertM:40,habitat:{elevMin:700,elevMax:2800,slopeMin:0,slopeMax:45,canopyMax:.9}},{name:`squirrel`,orientBaseM:.4,salt:1525,reaction:`hide`,cellM:120,presence:.45,herdMin:1,herdMax:2,spreadM:6,wanderM:5,speedMps:1.6,grazeS:3.5,strideM:.2,turnRate:6,visibleM:130,fadeStartM:95,scaleMin:.85,scaleMax:1.05,capacity:40,alertM:35,fleeMul:2.5,hideR:1.2,bailoutM:6,bailoutHopM:14,habitat:{elevMin:600,elevMax:2200,slopeMin:0,slopeMax:45,canopyMin:.9}}];function dw(e){let t=e.toPrecision(12);return t.includes(`.`)||t.includes(`e`)?t:`${t}.0`}function fw(e,t,n){if(!e.includes(t))throw Error(`wildlife.js: shader marker not found: ${t}`);return e.replace(t,n)}function pw(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function mw(e,t,n){let r=Math.imul(e|0,668265261)^Math.imul(t|0,374761393)^Math.imul(n,2654435769);return r=Math.imul(r^r>>>15,625341585),pw(r^r>>>13)}function Q(e,t,{swing:n=0,pivotY:r=0}={}){e.deleteAttribute(`uv`);let i=e.attributes.position.count,a=new Float32Array(i*3),o=new Float32Array(i*2),s=new G(t);for(let e=0;e<i;e++)a[e*3]=s.r,a[e*3+1]=s.g,a[e*3+2]=s.b,o[e*2]=n,o[e*2+1]=r;return e.setAttribute(`color`,new mr(a,3)),e.setAttribute(`aLeg`,new mr(o,2)),e}function hw(e,t,n=7){let r=new ua(e,t,2,n);return r.rotateX(Math.PI/2),r}var gw=(e,t)=>[[+e,+t,1],[-e,-t,1],[-e,+t,-1],[+e,-t,-1]],_w={legR:.055,legLen:.55,spreadX:.17,spreadZ:.3,hipY:.6},vw={legR:.045,legLen:.46,spreadX:.13,spreadZ:.24,hipY:.48},yw={legR:.035,legLen:.16,spreadX:.1,spreadZ:.11,hipY:.18},bw={legR:.035,legLen:.34,spreadX:.09,spreadZ:.16,hipY:.36},xw={legR:.016,legLen:.07,spreadX:.04,spreadZ:.05,hipY:.09};function Sw({legR:e,legLen:t,spreadX:n,spreadZ:r,hipY:i},a){return gw(n,r).map(([n,r,o])=>{let s=new fa(e,e*.6,t,5,1);return s.translate(n,i-t/2,r),Q(s,a,{swing:o,pivotY:i})})}function Cw(e,t,n,r,i){let a=[],o=t,s=n;for(let t of r){let n=-t.angle*Math.PI/180,r=Math.cos(n),c=Math.sin(n),l=new fa(t.r1,t.r0,t.len,5,1);l.rotateX(n),l.translate(e,o+r*t.len/2,s+c*t.len/2),a.push(Q(l,i)),o+=r*t.len,s+=c*t.len}return a}function ww(){let e=_w,t=hw(.27,.9);t.translate(0,.62,0);let n=new ua(.13,.3,2,6);n.rotateX(-.8),n.translate(0,.82,.34);let r=hw(.1,.2,6);r.translate(0,1.02,.55);let i=[Q(t,Z.ibex),Q(n,Z.ibex),Q(r,Z.ibex),...Sw(e,Z.ibex)],a=[{len:.2,angle:25,r0:.042,r1:.036},{len:.2,angle:60,r0:.036,r1:.028},{len:.18,angle:100,r0:.028,r1:.015}];return i.push(...Cw(.06,1.12,.48,a,Z.horn)),i.push(...Cw(-.06,1.12,.48,a,Z.horn)),i}function Tw(){let e=vw,t=hw(.21,.7);t.translate(0,.5,0);let n=new ua(.1,.26,2,6);n.rotateX(-.6),n.translate(0,.66,.26);let r=hw(.085,.18,6);r.translate(0,.85,.42);let i=[Q(t,Z.chamois),Q(n,Z.chamois),Q(r,Z.chamois),...Sw(e,Z.chamois)],a=[{len:.15,angle:8,r0:.022,r1:.018},{len:.09,angle:80,r0:.018,r1:.009}];return i.push(...Cw(.045,.92,.38,a,Z.horn)),i.push(...Cw(-.045,.92,.38,a,Z.horn)),i}function Ew(){let e=yw,t=hw(.13,.24,6);t.translate(0,.2,0);let n=hw(.09,.08,6);return n.translate(0,.26,.22),[Q(t,Z.marmot),Q(n,Z.marmot),...Sw(e,Z.marmot),...Cw(0,.21,-.19,[{len:.2,angle:115,r0:.045,r1:.03}],Z.marmot)]}function Dw(){let e=bw,t=hw(.14,.42);t.translate(0,.38,0);let n=new ua(.1,.14,2,6);n.rotateX(-1.05),n.translate(0,.4,.24);let r=hw(.075,.08,6);r.translate(0,.44,.34);let i=new fa(.018,.055,.12,5,1);i.rotateX(Math.PI/2),i.translate(0,.42,.45);let a=hw(.06,.1,6);a.translate(0,.34,.26);let o=[Q(t,Z.fox),Q(n,Z.fox),Q(r,Z.fox),Q(i,Z.fox),Q(a,Z.bib),...Sw(e,Z.stocking)];for(let e of[.055,-.055]){let t=new pa(.035,.09,4,1);t.translate(e,.51,.32),o.push(Q(t,Z.stocking))}return o.push(...Cw(0,.36,-.22,[{len:.22,angle:95,r0:.075,r1:.07},{len:.18,angle:110,r0:.07,r1:.05}],Z.fox)),o.push(...Cw(0,.28,-.6,[{len:.08,angle:110,r0:.05,r1:.03}],Z.bib)),o}function Ow(){let e=xw,t=hw(.055,.11,6);t.translate(0,.1,0);let n=hw(.045,.03,6);n.translate(0,.145,.09);let r=[Q(t,Z.squirrel),Q(n,Z.squirrel),...Sw(e,Z.squirrel)];for(let e of[.025,-.025]){let t=new pa(.012,.045,4,1);t.translate(e,.185,.075),r.push(Q(t,Z.squirrel))}return r.push(...Cw(0,.11,-.07,[{len:.08,angle:100,r0:.03,r1:.035},{len:.08,angle:55,r0:.035,r1:.035},{len:.07,angle:12,r0:.035,r1:.022}],Z.squirrel)),r}var kw={ibex:ww,chamois:Tw,marmot:Ew,fox:Dw,squirrel:Ow};function Aw(e,t){let{legR:n,legLen:r,spreadX:i,spreadZ:a,hipY:o}=e;return gw(i,a).map(([e,i,a])=>{let s=new fa(n*2.1,n*1.15,r*.46,6,1);return s.scale(.85,1,1),s.translate(e,o-r*.2,i),Q(s,t,{swing:a,pivotY:o})})}function jw(e,t){let{legR:n,legLen:r,spreadX:i,spreadZ:a,hipY:o}=e;return gw(i,a).map(([e,i,a])=>{let s=new fa(n*.62,n*.78,.07,6,1);return s.translate(e,o-r-.02,i),Q(s,t,{swing:a,pivotY:o})})}function Mw(e,t,n,r,i,{tilt:a=.5,sweep:o=.7}={}){let s=new pa(r*.42,r,5,1);return s.scale(1,1,.45),s.rotateX(o),s.rotateZ(e>0?-a:a),s.translate(e,t,n),Q(s,i)}function Nw(e,t,n,r,i,a){let o=Cw(e,t,n,r,i),s=t,c=n;return r.forEach((t,n)=>{let r=-t.angle*Math.PI/180,l=Math.cos(r),u=Math.sin(r),d=a[n]??0;for(let n=0;n<d;n++){let a=(n+.6)/(d+.2),f=t.r0+(t.r1-t.r0)*a,p=new no(f*.94,f*.3,4,8);p.rotateX(Math.PI/2+r),p.translate(e,s+l*t.len*a,c+u*t.len*a),o.push(Q(p,i))}s+=l*t.len,c+=u*t.len}),o}var Pw=[{len:.2,angle:25,r0:.042,r1:.036},{len:.2,angle:60,r0:.036,r1:.028},{len:.18,angle:100,r0:.028,r1:.015}];function Fw(){let e=_w,t=hw(.27,.9);t.scale(.76,1,1),t.translate(0,.62,0);let n=hw(.15,.34,7);n.scale(.8,1,1),n.translate(0,.5,.3);let r=new ua(.13,.3,2,6);r.rotateX(-.8),r.translate(0,.82,.34);let i=hw(.1,.2,6);i.translate(0,1.02,.55);let a=new fa(.055,.082,.12,6,1);a.rotateX(Math.PI/2),a.translate(0,1,.68);let o=[Q(t,Z.ibex),Q(n,Z.ibex),Q(r,Z.ibex),Q(i,Z.ibex),Q(a,Z.ibex),...Sw(e,Z.ibex),...Aw(e,Z.ibex),...jw(e,Z.horn),Mw(.075,1.06,.44,.13,Z.ibex),Mw(-.075,1.06,.44,.13,Z.ibex)];o.push(...Cw(0,.96,.6,[{len:.13,angle:172,r0:.035,r1:.02}],Z.horn)),o.push(...Cw(0,.66,-.44,[{len:.1,angle:120,r0:.035,r1:.028},{len:.07,angle:165,r0:.028,r1:.015}],Z.horn));let s=[4,4,3];return o.push(...Nw(.06,1.12,.48,Pw,Z.horn,s)),o.push(...Nw(-.06,1.12,.48,Pw,Z.horn,s)),o}function Iw(){let e=vw,t=hw(.21,.7);t.scale(.78,1,1),t.translate(0,.5,0);let n=hw(.12,.26,7);n.scale(.82,1,1),n.translate(0,.4,.24);let r=new ua(.1,.26,2,6);r.rotateX(-.6),r.translate(0,.66,.26);let i=hw(.085,.18,6);i.translate(0,.85,.42);let a=new fa(.042,.062,.1,6,1);a.rotateX(Math.PI/2),a.translate(0,.83,.54);let o=[Q(t,Z.chamois),Q(n,Z.chamois),Q(r,Z.chamois),Q(i,Z.chamois),Q(a,Z.chamois),...Sw(e,Z.chamois),...Aw(e,Z.chamois),...jw(e,Z.horn),Mw(.062,.89,.34,.15,Z.chamois,{sweep:.45}),Mw(-.062,.89,.34,.15,Z.chamois,{sweep:.45})];for(let e of[.055,-.055]){let t=new la(.022,.075,.16);t.translate(e,.865,.47),o.push(Q(t,Z.stocking))}o.push(...Cw(0,.56,-.34,[{len:.09,angle:140,r0:.03,r1:.018}],Z.stocking));let s=[{len:.15,angle:8,r0:.022,r1:.018},{len:.09,angle:80,r0:.018,r1:.009}];return o.push(...Nw(.045,.92,.38,s,Z.horn,[3,0])),o.push(...Nw(-.045,.92,.38,s,Z.horn,[3,0])),o}function Lw(){let e=bw,t=hw(.14,.42);t.scale(.86,1,1),t.translate(0,.38,0);let n=new ua(.1,.14,2,6);n.rotateX(-1.05),n.translate(0,.4,.24);let r=hw(.075,.08,6);r.translate(0,.44,.34);let i=new fa(.018,.055,.12,5,1);i.rotateX(Math.PI/2),i.translate(0,.42,.45);let a=hw(.06,.1,6);a.translate(0,.34,.26);let o=hw(.085,.05,7);o.scale(1.15,.9,1),o.translate(0,.43,.3);let s=[Q(t,Z.fox),Q(n,Z.fox),Q(o,Z.fox),Q(r,Z.fox),Q(i,Z.fox),Q(a,Z.bib),...Sw(e,Z.stocking),...Aw(e,Z.fox),...jw(e,Z.stocking)];for(let e of[.052,-.052]){let t=new pa(.042,.105,5,1);t.scale(1,1,.5),t.rotateX(.22),t.rotateZ(e>0?-.3:.3),t.translate(e,.52,.31),s.push(Q(t,Z.fox));let n=new pa(.022,.04,5,1);n.scale(1,1,.5),n.rotateX(.22),n.rotateZ(e>0?-.3:.3),n.translate(e,.575,.315),s.push(Q(n,Z.stocking))}return s.push(...Cw(0,.37,-.22,[{len:.18,angle:92,r0:.078,r1:.078},{len:.15,angle:99,r0:.078,r1:.062},{len:.12,angle:106,r0:.062,r1:.044}],Z.fox)),s.push(...Cw(0,.3,-.66,[{len:.08,angle:108,r0:.044,r1:.024}],Z.bib)),s}function Rw(){let e=yw,t=hw(.13,.24,6);t.translate(0,.2,0);let n=hw(.09,.08,6);n.translate(0,.26,.22);let r=new fa(.042,.07,.06,6,1);r.rotateX(Math.PI/2),r.translate(0,.242,.265);let i=[Q(t,Z.marmot),Q(n,Z.marmot),Q(r,Z.marmot),...Sw(e,Z.marmot),...Aw(e,Z.marmot),Mw(.07,.31,.19,.055,Z.marmot,{tilt:.9,sweep:.2}),Mw(-.07,.31,.19,.055,Z.marmot,{tilt:.9,sweep:.2})];return i.push(...Cw(0,.21,-.19,[{len:.12,angle:128,r0:.045,r1:.036},{len:.09,angle:152,r0:.036,r1:.022}],Z.marmot)),i}function zw(){let e=xw,t=hw(.055,.11,6);t.translate(0,.1,0);let n=hw(.045,.03,6);n.translate(0,.145,.09);let r=new fa(.022,.036,.035,5,1);r.rotateX(Math.PI/2),r.translate(0,.138,.125);let i=[Q(t,Z.squirrel),Q(n,Z.squirrel),Q(r,Z.squirrel),...Sw(e,Z.squirrel)];for(let e of[.025,-.025]){let t=new pa(.012,.05,4,1);t.translate(e,.187,.075),i.push(Q(t,Z.squirrel))}return i.push(...Cw(0,.11,-.07,[{len:.07,angle:100,r0:.032,r1:.042},{len:.07,angle:62,r0:.042,r1:.046},{len:.06,angle:28,r0:.046,r1:.04},{len:.05,angle:5,r0:.04,r1:.022}],Z.squirrel)),i}var Bw={ibex:Fw,chamois:Iw,marmot:Rw,fox:Lw,squirrel:zw},Vw=48;function Hw(e,{hi:t=!1}={}){let n=Gb((t?Bw:kw)[e.name]());n.setAttribute(`aSwing`,new xi(new Float32Array(e.capacity),1));let r=new go({vertexColors:!0,roughness:.92,metalness:0,flatShading:!0});r.onBeforeCompile=e=>{let t=e.vertexShader;t=fw(t,`#include <common>`,`#include <common>
  attribute vec2 aLeg;
  attribute float aSwing;`),t=fw(t,`#include <begin_vertex>`,`
      float legAngle = aLeg.x * aSwing * ${dw(sw)};
    ...
    `),e.vertexShader=t},Ev(r);let i=new ki(n,r,e.capacity);return i.name=`wildlife-${e.name}`,i.instanceMatrix.setUsage(Ue),i.count=0,i.frustumCulled=!1,i.castShadow=!1,i.receiveShadow=!1,i}function Uw({sampleGroundHeight:e,canopyAt:t,onAlarm:n=null}){let r=new En;r.name=`wildlife`;let i=uw.map(e=>{let t=Hw(e),n=Hw(e,{hi:!0});n.geometry.computeBoundingBox();let r=n.geometry.boundingBox;return{spec:e,mesh:t,meshHi:n,heightM:r.max.y-r.min.y,herds:new Map}});for(let e of i)r.add(e.mesh),r.add(e.meshHi);let a=new Zt,o=new Zt,s=new U,c=new Ot,l=new U,u=new U,d=new U,f=new U;function p(t,n){let r=e(t+12,n)-e(t-12,n),i=e(t,n+12)-e(t,n-12),a=Math.hypot(r,i)/24;return Math.atan(a)*180/Math.PI}function m(n,r,i){let a=n.habitat,o=e(r,i);if(!Number.isFinite(o)||o<a.elevMin||o>a.elevMax)return!1;let s=t(r,i);if(a.canopyMax!=null&&s>a.canopyMax||a.canopyMin!=null&&s<a.canopyMin)return!1;let c=p(r,i);return c>=a.slopeMin&&c<=a.slopeMax}function h(e,t,n){let r=mw(t,n,e.salt);if(r()>e.presence)return null;let i=(t+r())*e.cellM,a=(n+r())*e.cellM;if(!m(e,i,a))return null;let o=e.herdMin+Math.floor(r()*(e.herdMax-e.herdMin+1)),s=[];for(let c=0;c<o;c++){let o=r()*iw,l=Math.sqrt(r())*e.spreadM,u=i+Math.cos(o)*l,d=a+Math.sin(o)*l;s.push({id:`${e.name}:${t}:${n}:${c}`,x:u,z:d,homeX:u,homeZ:d,heading:r()*iw,targetX:u,targetZ:d,walking:!1,timer:r()*e.grazeS,phase:r()*iw,swing:0,gradX:0,gradZ:0,oriented:!1,bold:e.boldChance!=null&&r()<e.boldChance,watching:!1,scale:e.scaleMin+r()*(e.scaleMax-e.scaleMin)})}return{animals:s,rnd:r,siteX:i,siteZ:a}}function g(e,t,n){let r=((t-e+Math.PI)%iw+iw)%iw-Math.PI;return r>n?r=n:r<-n&&(r=-n),e+r}function _(e,n,r,i){let a=Math.atan2(e.x-n,e.z-r),o=Math.hypot(e.x-n,e.z-r),s=null;for(let c of[0,.5,-.5,1,-1]){let l=a+c,u=e.x+Math.sin(l)*i.bailoutHopM,d=e.z+Math.cos(l)*i.bailoutHopM;if(t(u,d)<i.habitat.canopyMin)continue;let f=TS(u,d,n,r),p=Math.hypot(f.x-n,f.z-r)-o;p>i.bailoutHopM*.4&&(!s||p>s.gain)&&(s={...f,gain:p})}return s}function v(e,t,r,i,a){let o=t.x-r,s=t.z-i,c=a>.001?1/a:0;if(t.watching=!1,e.reaction===`flee`&&(!t.alarmed&&a<e.alertM?(t.alarmed=!0,n?.({species:e.name,x:t.x,z:t.z,distanceM:a})):t.alarmed&&a>e.alertM*1.4&&(t.alarmed=!1)),e.reaction===`curious`&&t.bold&&a<e.curiousM)return a<e.standoffM*.85?(t.targetX=r+o*c*e.standoffM*1.3,t.targetZ=i+s*c*e.standoffM*1.3,t.walking=!0,e.escapeMul):a>e.standoffM*1.15?(t.targetX=r+o*c*e.standoffM,t.targetZ=i+s*c*e.standoffM,t.walking=!0,e.approachMul):(t.walking=!1,t.swing=0,t.watching=!0,1);if(e.reaction===`hide`&&a<e.alertM){let n=TS(t.homeX,t.homeZ,r,i);if(Math.hypot(n.x-r,n.z-i)<e.bailoutM){let a=_(n,r,i,e);a&&(t.homeX=a.x,t.homeZ=a.z,n=a)}let a=Math.hypot(n.x-r,n.z-i)||1;return t.targetX=n.x+(n.x-r)/a*e.hideR,t.targetZ=n.z+(n.z-i)/a*e.hideR,t.walking=!0,e.fleeMul}return a<e.alertM?(t.targetX=r+o*c*(e.alertM*1.8),t.targetZ=i+s*c*(e.alertM*1.8),t.walking=!0,e.fleeMul):1}function y(e,t,n,r,i,a){let o=v(e,n,i,a,Math.hypot(n.x-i,n.z-a));if(!n.walking){if(n.timer-=r,n.swing=0,n.watching){n.heading=g(n.heading,Math.atan2(i-n.x,a-n.z),e.turnRate*r);return}if(n.timer<=0){let r=t.rnd()*iw,i=e.wanderM*(.3+.7*t.rnd());n.targetX=n.homeX+Math.cos(r)*i,n.targetZ=n.homeZ+Math.sin(r)*i,n.walking=!0}return}let s=n.targetX-n.x,c=n.targetZ-n.z,l=Math.hypot(s,c);if(l<Math.min(.4,e.hideR?e.hideR*.25:.4)){n.walking=!1,n.swing=0,n.timer=e.grazeS*(.5+t.rnd());return}let u=e.speedMps*o,d=Math.min(l,u*r);n.x+=s/l*d,n.z+=c/l*d,n.heading=g(n.heading,Math.atan2(s,c),e.turnRate*r),n.phase+=d/e.strideM*iw,n.swing=Math.sin(n.phase)}function b(e){for(let t of i){let{spec:n,herds:r}=t,i=n.visibleM+n.cellM,a=Math.ceil(i/n.cellM),o=Math.floor(e.position.x/n.cellM),s=Math.floor(e.position.z/n.cellM),c=new Set;for(let t=s-a;t<=s+a;t++)for(let s=o-a;s<=o+a;s++){let a=(s+.5)*n.cellM-e.position.x,o=(t+.5)*n.cellM-e.position.z;if(Math.hypot(a,o)>i)continue;let l=`${s}:${t}`;c.add(l),r.has(l)||r.set(l,h(n,s,t))}for(let e of r.keys())c.has(e)||r.delete(e)}}let x=ow,S=1/0,C=1/0,w=0,T=0;function E(t,n){let r=n.position.x,p=n.position.z;w=r,T=p,x+=t,(x>=ow||Math.hypot(r-S,p-C)>aw)&&(b(n),x=0,S=r,C=p);let m=(typeof window>`u`?900:window.innerHeight)/(2*Math.tan(n.fov*Math.PI/360));for(let{spec:n,mesh:h,meshHi:g,heightM:_,herds:v}of i){let i=h.geometry.getAttribute(`aSwing`),b=g.geometry.getAttribute(`aSwing`),x=qb.value?_*m/Vw:0,S=0,C=0;for(let m of v.values())if(m)for(let _ of m.animals){y(n,m,_,t,r,p);let v=Math.hypot(_.x-r,_.z-p),w=v<=x;if((w?C:S)>=n.capacity)continue;let T=1-Ww(n.fadeStartM,n.visibleM,v);if(T<=0)continue;let E=e(_.x,_.z);if(!Number.isFinite(E))continue;let D=n.orientBaseM,O=(e(_.x+D,_.z)-e(_.x-D,_.z))/(2*D),k=(e(_.x,_.z+D)-e(_.x,_.z-D))/(2*D);if(_.oriented){let e=1-Math.exp(-t/cw);_.gradX+=(O-_.gradX)*e,_.gradZ+=(k-_.gradZ)*e}else _.gradX=O,_.gradZ=k,_.oriented=!0;u.set(-_.gradX,1,-_.gradZ).normalize(),d.set(Math.sin(_.heading),0,Math.cos(_.heading)),d.addScaledVector(u,-d.dot(u)),d.lengthSq()<1e-8&&d.set(0,0,1),d.normalize(),f.crossVectors(u,d),o.makeBasis(f,u,d),s.set(_.x,E-lw,_.z),c.setFromRotationMatrix(o),l.setScalar(_.scale*T),a.compose(s,c,l),w?(g.setMatrixAt(C,a),b.setX(C,_.swing),C++):(h.setMatrixAt(S,a),i.setX(S,_.swing),S++)}h.count=S,h.instanceMatrix.needsUpdate=!0,i.needsUpdate=!0,g.count=C,g.instanceMatrix.needsUpdate=!0,b.needsUpdate=!0}}function D(){return i.flatMap(({spec:n,mesh:r,meshHi:i,herds:a})=>{let o=[];for(let s of a.values())if(s)for(let a of s.animals){let s={id:a.id,species:n.name,x:a.x,z:a.z,elevationM:e(a.x,a.z),slopeDeg:p(a.x,a.z),canopy:t(a.x,a.z),camDistM:Math.hypot(a.x-w,a.z-T),walking:a.walking,swing:a.swing,bold:a.bold,watching:a.watching,alarmed:!!a.alarmed,drawn:r.count+i.count,drawnHi:i.count};if(n.reaction===`hide`){let e=TS(a.homeX,a.homeZ,w,T),t=[a.x-e.x,a.z-e.z],n=[w-e.x,T-e.z],r=Math.hypot(...t)||1,i=Math.hypot(...n)||1;s.treeX=e.x,s.treeZ=e.z,s.treeDistM=r,s.treeSpacingM=6,s.shielded=(t[0]*n[0]+t[1]*n[1])/(r*i)<0}o.push(s)}return o})}function O(e,t,n,r=90){let a=i.find(t=>t.spec.name===e);if(!a)return null;let{spec:o}=a,s=Math.floor(t/o.cellM),c=Math.floor(n/o.cellM);for(let i=0;i<=r;i++){let r=[];for(let e=c-i;e<=c+i;e++)for(let t=s-i;t<=s+i;t++){if(i>0&&Math.abs(t-s)!==i&&Math.abs(e-c)!==i)continue;let n=h(o,t,e);n&&r.push(n)}if(r.length){r.sort((e,r)=>Math.hypot(e.siteX-t,e.siteZ-n)-Math.hypot(r.siteX-t,r.siteZ-n));let a=r[0].animals[0];return{species:e,x:a.x,z:a.z,ring:i,distanceM:Math.hypot(a.x-t,a.z-n)}}}return null}return{object:r,update:E,snapshot:D,findNearest:O,species:uw.map(e=>e.name),stats:{capacity:uw.reduce((e,t)=>e+t.capacity,0),trianglesPerAnimal:Object.fromEntries(i.map(({spec:e,mesh:t})=>[e.name,t.geometry.index?t.geometry.index.count/3:t.geometry.attributes.position.count/3]))}}}function Ww(e,t,n){let r=Math.min(1,Math.max(0,(n-e)/(t-e)));return r*r*(3-2*r)}var Gw=Math.PI*2,Kw=9.81,qw={eagle:7299666,eagleNape:12492138,vultureBody:14061926,vultureWing:6842483,chough:4868686,bill:16776960,nutcracker:8284513,white:16777215},Jw=.85,Yw=60,Xw=2,Zw=140,Qw=[{name:`eagle`,kind:`soar`,salt:31249,cellM:2600,presence:.6,minPerSite:1,maxPerSite:2,speedMps:14,climbMps:2,sinkMps:.7,radiusMin:45,radiusMax:95,aglMin:60,aglMax:450,glideMaxM:2600,flapAmp:0,visibleM:1900,fadeStartM:1500,scaleMin:.95,scaleMax:1.1,capacity:8,habitat:{elevMin:2e3,exposureMin:.22}},{name:`vulture`,kind:`soar`,salt:31522,cellM:4200,presence:.32,minPerSite:1,maxPerSite:1,speedMps:15,climbMps:2.2,sinkMps:.6,radiusMin:70,radiusMax:140,aglMin:120,aglMax:700,glideMaxM:4200,flapAmp:0,visibleM:2300,fadeStartM:1800,scaleMin:1,scaleMax:1.15,capacity:6,habitat:{elevMin:2200,exposureMin:.2}},{name:`chough`,kind:`flock`,salt:31795,siteCategories:[`pass`,`hut`],siteElevMin:1900,sitePresence:.55,flockMin:8,flockMax:22,orbitRadiusM:45,orbitSpeedMps:3.5,centreAglMin:14,centreAglMax:38,memberRadiusM:13,memberSpeedMps:6,flapAmp:1,flapHz:3.4,curiousM:110,standoffM:15,callEveryS:[2.5,7],callEarshotM:320,visibleM:700,fadeStartM:520,scaleMin:.9,scaleMax:1.1,capacity:110},{name:`nutcracker`,kind:`canopy`,salt:32068,cellM:430,presence:.32,minPerSite:1,maxPerSite:2,speedMps:7.5,undulateM:26,undulateAmpM:3.2,cruiseAglM:21,hopMinM:45,hopMaxM:95,flapAmp:1,alertM:45,visibleM:220,fadeStartM:160,scaleMin:.9,scaleMax:1.05,capacity:28,habitat:{elevMin:900,elevMax:2300,canopyMin:.35}}];function $w(e){let t=e.toPrecision(12);return t.includes(`.`)||t.includes(`e`)?t:`${t}.0`}function eT(e,t,n){if(!e.includes(t))throw Error(`birds.js: shader marker not found: ${t}`);return e.replace(t,n)}function tT(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function nT(e,t,n){let r=Math.imul(e|0,668265261)^Math.imul(t|0,374761393)^Math.imul(n,2654435769);return r=Math.imul(r^r>>>15,625341585),tT(r^r>>>13)}function rT(e,t,n){let r=Math.min(1,Math.max(0,(n-e)/(t-e)));return r*r*(3-2*r)}function iT(e,t,n){return e+(t-e)*n}function aT(e,t,{wing:n=0}={}){e.deleteAttribute(`uv`);let r=e.attributes.position.count,i=new Float32Array(r*3),a=new Float32Array(r),o=new G(t);for(let e=0;e<r;e++)i[e*3]=o.r,i[e*3+1]=o.g,i[e*3+2]=o.b,a[e]=n;return e.setAttribute(`color`,new mr(i,3)),e.setAttribute(`aWing`,new mr(a,1)),e}function oT(e,t,n=6){let r=new ua(e,t,2,n);return r.rotateX(Math.PI/2),r}function sT({x0:e,x1:t,zRoot:n,zTip:r,chordRoot:i,chordTip:a,rise:o=0,y:s=0}){let c=new kr,l=new Float32Array([e,s,n+i/2,e,s,n-i/2,t,s+o,r+a/2,t,s+o,r-a/2]);return c.setAttribute(`position`,new mr(l,3)),c.setIndex([0,1,2,1,3,2]),c.computeVertexNormals(),c}function cT(){let e=oT(.085,.36),t=oT(.062,.05);t.translate(0,.015,.25);let n=oT(.055,.06);n.translate(0,.03,.16);let r=new pa(.028,.07,5);r.rotateX(Math.PI/2),r.translate(0,.005,.32);let i=[aT(e,qw.eagle),aT(t,qw.eagle),aT(n,qw.eagleNape),aT(r,qw.eagleNape),aT(sT({x0:-.15,x1:.15,zRoot:-.3,zTip:-.3,chordRoot:.34,chordTip:.34}),qw.eagle)];for(let e of[1,-1])i.push(aT(sT({x0:e*.07,x1:e*1.08,zRoot:.06,zTip:-.1,chordRoot:.34,chordTip:.17,rise:.075}),qw.eagle,{wing:1}));return i}function lT(){let e=oT(.1,.42),t=oT(.06,.05);t.translate(0,.02,.29);let n=new pa(.03,.08,5);n.rotateX(Math.PI/2),n.translate(0,.01,.37);let r=[aT(e,qw.vultureBody),aT(t,qw.vultureBody),aT(n,qw.vultureWing),aT(sT({x0:-.13,x1:.13,zRoot:-.34,zTip:-.34,chordRoot:.16,chordTip:.16}),qw.vultureWing),aT(sT({x0:-.09,x1:.09,zRoot:-.52,zTip:-.52,chordRoot:.42,chordTip:.42}),qw.vultureWing)];for(let e of[1,-1])r.push(aT(sT({x0:e*.08,x1:e*1.4,zRoot:.04,zTip:-.16,chordRoot:.33,chordTip:.13,rise:.03}),qw.vultureWing,{wing:1}));return r}function uT(){let e=oT(.042,.13),t=oT(.033,.02);t.translate(0,.012,.095);let n=new pa(.011,.045,4);n.rotateX(Math.PI/2),n.translate(0,.008,.135);let r=[aT(e,qw.chough),aT(t,qw.chough),aT(n,qw.bill),aT(sT({x0:-.045,x1:.045,zRoot:-.13,zTip:-.13,chordRoot:.14,chordTip:.14}),qw.chough)];for(let e of[1,-1])r.push(aT(sT({x0:e*.035,x1:e*.37,zRoot:.02,zTip:-.05,chordRoot:.13,chordTip:.06,rise:.01}),qw.chough,{wing:1}));return r}function dT(){let e=oT(.04,.11),t=oT(.032,.02);t.translate(0,.01,.085);let n=new pa(.012,.05,4);n.rotateX(Math.PI/2),n.translate(0,.004,.125);let r=[aT(e,qw.nutcracker),aT(t,qw.nutcracker),aT(n,qw.nutcracker),aT(sT({x0:-.04,x1:.04,zRoot:-.1,zTip:-.1,chordRoot:.09,chordTip:.09}),qw.nutcracker),aT(sT({x0:-.04,x1:.04,zRoot:-.15,zTip:-.15,chordRoot:.03,chordTip:.03}),qw.white)];for(let e of[1,-1])r.push(aT(sT({x0:e*.032,x1:e*.26,zRoot:.015,zTip:-.03,chordRoot:.12,chordTip:.07,rise:.008}),qw.nutcracker,{wing:1}));return r}var fT={eagle:cT,vulture:lT,chough:uT,nutcracker:dT};function pT(e){let t=Gb(fT[e.name]());t.setAttribute(`aFlap`,new xi(new Float32Array(e.capacity),1));let n=new go({vertexColors:!0,roughness:.9,metalness:0,side:2,flatShading:!0});n.onBeforeCompile=e=>{let t=e.vertexShader;t=eT(t,`#include <common>`,`#include <common>
  attribute float aWing;
  attribute float aFlap;`),t=eT(t,`#include <begin_vertex>`,`
      float wingAngle = aWing * aFlap * ${$w(Jw)} * sign( position.x );
    ...
    `),e.vertexShader=t},Ev(n);let r=new ki(t,n,e.capacity);return r.name=`birds-${e.name}`,r.instanceMatrix.setUsage(Ue),r.count=0,r.frustumCulled=!1,r.castShadow=!1,r.receiveShadow=!1,r}function mT({sampleGroundHeight:e,canopyAt:t,pois:n=[],onCall:r=null}){let i=new En;i.name=`birds`;let a=Qw.map(e=>({spec:e,mesh:pT(e),sites:new Map}));for(let e of a)i.add(e.mesh);let o=new Zt,s=new Zt,c=new U,l=new Ot,u=new U,d=new U,f=new U,p=new U,m=new U(0,1,0),h=0,g=1;function _(t,n,r){let i=0,a=0;for(let[r,o]of[[Zw,0],[-140,0],[0,Zw],[0,-140]]){let s=e(t+r,n+o);Number.isFinite(s)&&(i+=s,a++)}return a?rT(0,60,r-i/a):0}function v(t,n,r){let i=nT(n,r,t.salt);if(i()>t.presence)return null;let a=(n+.5)*t.cellM+(i()-.5)*t.cellM*.6,o=(r+.5)*t.cellM+(i()-.5)*t.cellM*.6,s=e(a,o);if(!Number.isFinite(s)||s<t.habitat.elevMin)return null;let c=_(a,o,s);if(c<t.habitat.exposureMin)return null;let l=t.minPerSite+Math.floor(i()*(t.maxPerSite-t.minPerSite+1)),u=[];for(let e=0;e<l;e++){let l=iT(t.radiusMin,t.radiusMax,i());u.push({id:`${t.name}:${n}:${r}:${e}`,numericId:g++,mode:`circle`,cx:a+(i()-.5)*40,cz:o+(i()-.5)*40,radius:l,dir:i()<.5?1:-1,phase:i()*Gw,x:a,y:s+iT(t.aglMin,t.aglMax*.5,i()),z:o,vx:0,vy:0,vz:0,bank:0,flap:0,glideX:0,glideZ:1,glideLeft:0,scale:iT(t.scaleMin,t.scaleMax,i()),exposure:c})}return{x:a,z:o,ground:s,exposure:c,birds:u,rnd:i}}function y(t,n,r){let i=tT(Math.imul(r+1,2654435769)^t.salt);if(i()>t.sitePresence)return null;let a=e(n.local.x,n.local.z);if(!Number.isFinite(a))return null;let o=t.flockMin+Math.floor(i()*(t.flockMax-t.flockMin+1)),s=[];for(let e=0;e<o;e++)s.push({radius:iT(3,t.memberRadiusM,i()**.6),phase:i()*Gw,rate:iT(.6,1.5,i()),dy:(i()-.5)*9,bobPhase:i()*Gw,flapPhase:i()*Gw,scale:iT(t.scaleMin,t.scaleMax,i())});return{name:n.name,x:n.local.x,z:n.local.z,ground:a,elevationM:n.elevationM,category:n.category,cx:n.local.x,cy:a+iT(t.centreAglMin,t.centreAglMax,i()),cz:n.local.z,orbitPhase:i()*Gw,orbitDir:i()<.5?1:-1,inspecting:!1,callIn:iT(t.callEveryS[0],t.callEveryS[1],i()),members:s,rnd:i}}function b(n,r,i){let a=nT(r,i,n.salt);if(a()>n.presence)return null;let o=(r+.5)*n.cellM+(a()-.5)*n.cellM*.7,s=(i+.5)*n.cellM+(a()-.5)*n.cellM*.7,c=e(o,s);if(!Number.isFinite(c)||c<n.habitat.elevMin||c>n.habitat.elevMax||t(o,s)<n.habitat.canopyMin)return null;let l=n.minPerSite+Math.floor(a()*(n.maxPerSite-n.minPerSite+1)),u=[];for(let e=0;e<l;e++){let t=a()*Gw;u.push({id:`${n.name}:${r}:${i}:${e}`,numericId:g++,x:o+Math.cos(t)*12,z:s+Math.sin(t)*12,y:c+n.cruiseAglM,homeX:o,homeZ:s,targetX:o,targetZ:s,travelled:0,heading:t,bank:0,flap:0,alarmed:!1,scale:iT(n.scaleMin,n.scaleMax,a()),rnd:a})}return{x:o,z:s,ground:c,birds:u,rnd:a}}function x(e){let t=e.position.x,n=e.position.z;for(let e of a){let{spec:r,sites:i}=e;if(r.kind===`flock`){for(let e=0;e<k.length;e++){let a=k[e];if(Math.hypot(a.local.x-t,a.local.z-n)>r.visibleM*1.2)continue;let o=`poi:${e}`;i.has(o)||i.set(o,y(r,a,e))}continue}let a=r.visibleM*2.5;for(let[e,o]of i){let s=o?o.x:(Number(e.split(`:`)[0])+.5)*r.cellM,c=o?o.z:(Number(e.split(`:`)[1])+.5)*r.cellM;Math.hypot(s-t,c-n)>a&&i.delete(e)}let o=Math.ceil(r.visibleM/r.cellM)+1,s=Math.floor(t/r.cellM),c=Math.floor(n/r.cellM);for(let e=c-o;e<=c+o;e++)for(let t=s-o;t<=s+o;t++){let n=`${t}:${e}`;i.has(n)||i.set(n,r.kind===`soar`?v(r,t,e):b(r,t,e))}}}function S(t,n,r,i){let a=e(r.x,r.z),o=Number.isFinite(a)?a:n.ground;if(r.mode===`circle`){let e=t.speedMps/r.radius*r.dir;r.phase+=e*i;let a=r.cx+Math.cos(r.phase)*r.radius,s=r.cz+Math.sin(r.phase)*r.radius;if(r.y+=t.climbMps*i,r.bank=Math.atan(t.speedMps*t.speedMps/(r.radius*Kw))*-r.dir,r.vx=(a-r.x)/i,r.vz=(s-r.z)/i,r.vy=t.climbMps,r.x=a,r.z=s,r.y-o>t.aglMax){r.mode=`glide`;let e=n.rnd()*Gw;r.glideX=Math.sin(e),r.glideZ=Math.cos(e),r.glideLeft=iT(t.glideMaxM*.35,t.glideMaxM,n.rnd())}return}let s=t.speedMps*1.25*i;r.x+=r.glideX*s,r.z+=r.glideZ*s,r.y-=t.sinkMps*i,r.glideLeft-=s,r.vx=r.glideX*t.speedMps*1.25,r.vz=r.glideZ*t.speedMps*1.25,r.vy=-t.sinkMps,r.bank+=(0-r.bank)*(1-Math.exp(-i/1.2)),(r.glideLeft<=0||r.y-o<t.aglMin)&&(r.mode=`circle`,r.cx=r.x-Math.cos(r.phase)*r.radius,r.cz=r.z-Math.sin(r.phase)*r.radius,r.dir=n.rnd()<.5?1:-1,r.y=Math.max(r.y,o+t.aglMin))}function C(t,n,i,a){let o=a.position.x,s=a.position.y,c=a.position.z,l=Math.hypot(n.x-o,n.z-c);n.orbitPhase+=t.orbitSpeedMps/t.orbitRadiusM*n.orbitDir*i;let u=n.x+Math.cos(n.orbitPhase)*t.orbitRadiusM,d=n.z+Math.sin(n.orbitPhase)*t.orbitRadiusM,f=n.cy;if(n.inspecting=l<t.curiousM,n.inspecting){let e=Math.hypot(n.cx-o,n.cz-c)||1,r=Math.max(t.standoffM,8);u=o+(n.cx-o)/e*r,d=c+(n.cz-c)/e*r,f=s+7}let p=1-Math.exp(-i/(n.inspecting?1.6:3.5));n.cx+=(u-n.cx)*p,n.cy+=(f-n.cy)*p,n.cz+=(d-n.cz)*p;let m=e(n.cx,n.cz);Number.isFinite(m)&&(n.cy=Math.max(n.cy,m+4)),r&&(n.callIn-=i,n.callIn<=0&&(n.callIn=iT(t.callEveryS[0],t.callEveryS[1],n.rnd()),Math.hypot(n.cx-o,n.cz-c)<t.callEarshotM&&r({species:t.name,x:n.cx,z:n.cz,distanceM:l})))}function w(t,n,i,a,o){let s=o.position.x,c=o.position.z,l=Math.hypot(i.x-s,i.z-c),u=i.targetX-i.x,d=i.targetZ-i.z,f=Math.hypot(u,d);if(l<t.alertM&&!i.alarmed?(i.alarmed=!0,T(t,i,Math.atan2(i.x-s,i.z-c)+(i.rnd()-.5)*.8),u=i.targetX-i.x,d=i.targetZ-i.z,f=Math.hypot(u,d),r?.({species:t.name,x:i.x,z:i.z,distanceM:l})):i.alarmed&&l>t.alertM*1.5&&(i.alarmed=!1),f<2){T(t,i,i.rnd()*Gw);return}let p=t.speedMps*a;i.x+=u/f*p,i.z+=d/f*p,i.travelled+=p,i.heading=Math.atan2(u,d);let m=e(i.x,i.z),h=Number.isFinite(m)?m:n.ground,g=Math.sin(i.travelled/t.undulateM*Gw);i.y=h+t.cruiseAglM+g*t.undulateAmpM,i.flap=Math.max(0,Math.cos(i.travelled/t.undulateM*Gw)),i.vx=u/f*t.speedMps,i.vz=d/f*t.speedMps,i.vy=g*.6,i.bank=0}function T(e,n,r){for(let i=0;i<5;i++){let a=r+(i===0?0:(n.rnd()-.5)*2.2),o=iT(e.hopMinM,e.hopMaxM,n.rnd()),s=n.x+Math.sin(a)*o,c=n.z+Math.cos(a)*o;if(t(s,c)>=e.habitat.canopyMin*.7){n.targetX=s,n.targetZ=c,n.travelled=0;return}}n.targetX=n.homeX,n.targetZ=n.homeZ,n.travelled=0}function E(e,t,n,r){if(d.set(e,t,n),d.lengthSq()<1e-8&&d.set(0,0,1),d.normalize(),p.crossVectors(m,d),p.lengthSq()<1e-8&&p.set(1,0,0),p.normalize(),f.crossVectors(d,p),r!==0){let e=Math.cos(r),t=Math.sin(r),n=p.x*e+f.x*t,i=p.y*e+f.y*t,a=p.z*e+f.z*t;f.set(f.x*e-p.x*t,f.y*e-p.y*t,f.z*e-p.z*t),p.set(n,i,a)}s.makeBasis(p,f,d),l.setFromRotationMatrix(s)}function D(e,t){let{spec:n,mesh:r,sites:i}=e,a=r.geometry.getAttribute(`aFlap`),s=t.position.x,d=t.position.y,f=t.position.z,p=0;for(let e of i.values())if(e){if(n.kind===`flock`){for(let t of e.members){if(p>=n.capacity)break;let i=t.phase+h*n.memberSpeedMps*t.rate/Math.max(t.radius,1),m=e.cx+Math.cos(i)*t.radius,g=e.cz+Math.sin(i)*t.radius,_=e.cy+t.dy+Math.sin(h*.9+t.bobPhase)*1.6,v=Math.hypot(m-s,_-d,g-f),y=1-rT(n.fadeStartM,n.visibleM,v);if(y<=0)continue;let b=n.memberSpeedMps*t.rate;E(-Math.sin(i)*b,0,Math.cos(i)*b,Math.atan(b*b/(Math.max(t.radius,1)*Kw))*-1),c.set(m,_,g),u.setScalar(t.scale*y),o.compose(c,l,u),r.setMatrixAt(p,o),a.setX(p,Math.sin(h*n.flapHz*Gw+t.flapPhase)*n.flapAmp),p++}continue}for(let t of e.birds){if(p>=n.capacity)break;let e=Math.hypot(t.x-s,t.y-d,t.z-f),i=1-rT(n.fadeStartM,n.visibleM,e);i<=0||(E(t.vx,t.vy,t.vz,t.bank),c.set(t.x,t.y,t.z),u.setScalar(t.scale*i),o.compose(c,l,u),r.setMatrixAt(p,o),a.setX(p,t.flap*n.flapAmp),p++)}}r.count=p,r.instanceMatrix.needsUpdate=!0,a.needsUpdate=!0}let O=Qw.find(e=>e.name===`chough`),k=n.filter(e=>O.siteCategories.includes(e.category)&&(e.elevationM??0)>=O.siteElevMin),A=Xw,ee=1/0,j=1/0,M=0,te=0;function N(e,t){h+=e,M=t.position.x,te=t.position.z,A+=e,(A>=Xw||Math.hypot(M-ee,te-j)>Yw)&&(x(t),A=0,ee=M,j=te);for(let n of a){let{spec:r,sites:i}=n;for(let n of i.values())if(n){if(r.kind===`flock`){C(r,n,e,t);continue}for(let i of n.birds)r.kind===`soar`?S(r,n,i,e):w(r,n,i,e,t)}D(n,t)}}function P(){let n=[];for(let{spec:r,mesh:i,sites:o}of a)for(let a of o.values())if(a){if(r.kind===`flock`){let t=e(a.cx,a.cz);n.push({species:r.name,site:a.name,category:a.category,siteElevationM:a.elevationM,x:a.cx,y:a.cy,z:a.cz,aglM:a.cy-(Number.isFinite(t)?t:a.ground),members:a.members.length,inspecting:a.inspecting,camDistM:Math.hypot(a.cx-M,a.cz-te),anchorDistM:Math.hypot(a.x-M,a.z-te),drawn:i.count});continue}for(let o of a.birds){let s=e(o.x,o.z);n.push({species:r.name,id:o.id,x:o.x,y:o.y,z:o.z,groundM:s,aglM:o.y-s,mode:o.mode??`cruise`,bankDeg:o.bank*180/Math.PI,speedMps:Math.hypot(o.vx??0,o.vy??0,o.vz??0),groundSpeedMps:Math.hypot(o.vx??0,o.vz??0),radiusM:o.radius??null,siteX:a.x,siteZ:a.z,exposure:a.exposure??null,canopy:t(o.x,o.z),flap:o.flap,camDistM:Math.hypot(o.x-M,o.z-te),drawn:i.count})}}return n}function ne(e,t,n){let r=a.find(t=>t.spec.name===e);if(!r)return null;let{spec:i}=r,o=i.kind===`flock`?null:Math.ceil(25e3/i.cellM);if(o!=null){let e=Math.floor(t/i.cellM),a=Math.floor(n/i.cellM);for(let t=a-o;t<=a+o;t++)for(let n=e-o;n<=e+o;n++){let e=`${n}:${t}`;r.sites.has(e)||r.sites.set(e,i.kind===`soar`?v(i,n,t):b(i,n,t))}}else for(let e=0;e<k.length;e++){let t=`poi:${e}`;r.sites.has(t)||r.sites.set(t,y(i,k[e],e))}let s=null;for(let a of r.sites.values()){if(!a)continue;let r=i.kind===`flock`?a.x:a.birds[0]?.x,o=i.kind===`flock`?a.z:a.birds[0]?.z;if(r==null)continue;let c=Math.hypot(r-t,o-n);(!s||c<s.distanceM)&&(s={species:e,x:r,z:o,y:i.kind===`flock`?a.cy:a.birds[0].y,distanceM:c,site:a.name??null})}return s}return{object:i,update:N,snapshot:P,findNearest:ne,species:Qw.map(e=>e.name),stats:{flockSites:k.length,capacity:Qw.reduce((e,t)=>e+t.capacity,0),trianglesPerBird:Object.fromEntries(a.map(({spec:e,mesh:t})=>[e.name,t.geometry.index?t.geometry.index.count/3:t.geometry.attributes.position.count/3]))}}}var hT=.35,gT=8,_T=6,vT=.25,yT=.08,bT={waterfall:{radiusM:600,gain:.85,low:1,high:.9},river:{radiusM:250,gain:.6,low:.45,high:.75},lake:{radiusM:110,gain:.22,low:.55,high:.3}},xT=640,ST=40,CT={marmot:{f0:3500,f1:2750,durS:.3,gain:.5,bandQ:5,earshotM:240,notesMin:2,notesMax:5,gapS:[.45,.85]},chamois:{f0:2200,f1:1900,durS:.14,gain:.3,bandQ:7,earshotM:180,notesMin:1,notesMax:3,gapS:[.5,.9]},chough:{f0:2600,f1:1850,durS:.2,gain:.32,bandQ:4,earshotM:380,notesMin:2,notesMax:4,gapS:[.22,.5]},nutcracker:{f0:950,f1:780,durS:.34,gain:.38,bandQ:1.6,earshotM:240,notesMin:1,notesMax:3,gapS:[.3,.62],wave:`sawtooth`,rattleHz:30}},wT=.012,TT=.35;function ET(e,t,n,r,i,a){let o=[];for(let s=0;s<e;s++){let c=e>1?s/(e-1):0;o.push([t+(n-t)*c,r,i+(a-i)*c])}return o}var DT=[{name:`chaffinch`,salt:1441,habitat:{elevMin:700,elevMax:2100,canopyMin:.22},cellM:140,presence:.42,earshotM:200,everyS:[26,58],gain:.19,voice:{f0:4100,f1:3750,bandQ:6},phrase:[...ET(9,1,.62,.075,.155,.095),[.68,.11,.14],[.86,.2,.2]]},{name:`coaltit`,salt:1458,habitat:{elevMin:900,elevMax:2200,canopyMin:.35},cellM:160,presence:.35,earshotM:160,everyS:[18,42],gain:.13,voice:{f0:4900,f1:4700,bandQ:8},phrase:[[1,.09,.135],[.8,.09,.3]],repeat:[3,6]},{name:`cuckoo`,salt:1475,habitat:{elevMin:800,elevMax:1900,canopyMin:.08,canopyMax:.75},cellM:500,presence:.25,earshotM:750,everyS:[80,180],gain:.22,voice:{f0:735,f1:722,bandQ:2.2,wave:`sine`},phrase:[[1,.17,.3],[.79,.24,.24]],repeat:[3,8],repeatGapS:[.9,1.4]},{name:`pipit`,salt:1492,habitat:{elevMin:1900,elevMax:2900,canopyMax:.12},cellM:130,presence:.4,earshotM:210,everyS:[26,55],gain:.12,voice:{f0:5200,f1:5050,bandQ:9},phrase:ET(11,1,.88,.05,.105,.075)},{name:`tawnyowl`,salt:1509,nocturnal:!0,habitat:{elevMin:700,elevMax:1900,canopyMin:.25},cellM:500,presence:.35,earshotM:800,everyS:[40,110],gain:.2,voice:{f0:470,f1:452,bandQ:3,wave:`sine`,rattleHz:13,rattleDepth:.2},phrase:[[1,.5,2.6],[1,.08,.24],[.97,.1,.16],[.94,.8,.8]],repeat:[1,2],repeatGapS:[6,11]}],OT=2,kT=.65,AT=.85,jT=2,MT=.09,NT=.4,PT=200,FT=.7,IT=.2,LT=.12,RT={grass:{type:`lowpass`,freq:850,Q:.9,durS:.11,attackS:.006,gain:.8},forest:{type:`lowpass`,freq:620,Q:.8,durS:.14,attackS:.008,gain:.75,grains:2,grainGain:.35},scree:{type:`bandpass`,freq:2100,Q:.7,durS:.09,attackS:.003,gain:1,grains:4,grainGain:.5},snow:{type:`bandpass`,freq:3200,Q:1.4,durS:.16,attackS:.004,gain:.85},wet:{type:`lowpass`,freq:420,Q:1.2,durS:.13,attackS:.01,gain:.9}},zT=.45,BT=.5,VT=.35,HT=3800,UT=3e3,WT=30,GT=12,KT=new U;function qT(e,t,n){return Math.min(n,Math.max(t,e))}function JT(e,t,n){let r=qT((n-e)/(t-e),0,1);return r*r*(3-2*r)}function YT(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function XT(e,t,n){let r=Math.imul(e|0,668265261)^Math.imul(t|0,374761393)^Math.imul(n,2654435769);return r=Math.imul(r^r>>>15,625341585),YT(r^r>>>13)}function ZT(e,t){return t[0]+(t[1]-t[0])*e()}function QT(e,t,n){let r=Math.max(1,Math.floor(e.sampleRate*t)),i=e.createBuffer(1,r,e.sampleRate),a=i.getChannelData(0),o=0,s=0,c=0,l=0,u=0,d=0,f=0;for(let e=0;e<r;e++){let t=n()*2-1;o=.99886*o+t*.0555179,s=.99332*s+t*.0750759,c=.969*c+t*.153852,l=.8665*l+t*.3104856,u=.55*u+t*.5329522,d=-.7616*d-t*.016898,a[e]=(o+s+c+l+u+d+f+t*.5362)*.11,f=t*.115926}return i}function $T(e,t,n){if(!e.length)return;n(e[0][0],e[0][1]);let r=0;for(let i=1;i<e.length;i++){let[a,o]=e[i-1],[s,c]=e[i],l=Math.hypot(s-a,c-o);if(l<=1e-6)continue;let u=t-r;for(;u<=l;){let e=u/l;n(a+(s-a)*e,o+(c-o)*e),u+=t}r=(r+l)%t}}function eE(e){let t=new Map,n=0,r=(e,t)=>`${Math.floor(e/xT)},${Math.floor(t/xT)}`,i=(e,i)=>(a,o)=>{let s=r(a,o),c=t.get(s);c||t.set(s,c=[]),c.push({x:a,z:o,kind:e,strength:i}),n++};for(let t of e.lakes??[]){let e=t.ring??[],n=0;for(let t=1;t<e.length;t++)n+=Math.hypot(e[t][0]-e[t-1][0],e[t][1]-e[t-1][1]);$T(e,ST,i(`lake`,qT(n/900,.35,1)))}for(let t of e.rivers??[])$T((t.line??[]).map(([e,,t])=>[e,t]),ST,i(`river`,1));for(let t of e.streams??[])$T((t.line??[]).map(([e,,t])=>[e,t]),ST,i(`river`,.45));for(let t of e.waterfalls??[]){let e=t.centerline?.[t.centerline.length-1];e&&i(`waterfall`,qT(.45+(t.dropM??0)/90,.5,1.35))(e[0],e[2])}function a(e,n){let r=Math.floor(e/xT),i=Math.floor(n/xT),a={};for(let e of Object.keys(bT))a[e]={distanceM:1/0,strength:0};for(let o=-1;o<=1;o++)for(let s=-1;s<=1;s++){let c=t.get(`${r+o},${i+s}`);if(c)for(let t of c){let r=Math.hypot(t.x-e,t.z-n),i=a[t.kind];r<i.distanceM&&(i.distanceM=r,i.strength=t.strength)}}return a}return{query:a,count:n,cells:t.size}}function tE({context:e=null,canopyAt:t=null,sampleGroundHeight:n=null,water:r=null,random:i=Math.random,immediate:a=!1}={}){let o=e,s=null,c=null,l=null,u={canopyAt:t,sampleGroundHeight:n},d=r?eE(r):null,f=!0,p=.5,m=.5,h=0,g=0,_=1/gT,v=0,y=null,b=0,x=0,S=-1/0,C=0,w=DT.map(()=>new Map),T=OT,E=0,D=null,O=0,k=Object.fromEntries(DT.map(e=>[e.name,0])),A=0,ee=null,j=0,M=0,te=0,N=null,P=null,ne={started:!1,enabled:f,strength:0,altitude:0,exposure:0,canopy:0,gust:0,rain:0,snow:0,speedMps:0,water:null,gains:{},night:0,singers:0,songs:0,surface:null,steps:0};function re(e,t){let n=Number.isFinite(t)?t:0;a?e.setValueAtTime(n,o.currentTime):e.setTargetAtTime(n,o.currentTime,vT)}function ie(e,{type:t,freq:n,Q:r,rate:a}){let s=o.createBufferSource();s.buffer=e,s.loop=!0,s.playbackRate.value=a;let l=o.createBiquadFilter();l.type=t,l.frequency.value=n,l.Q.value=r;let u=o.createGain();return u.gain.value=0,s.connect(l).connect(u).connect(c),s.start(0,i()*_T),{source:s,filter:l,gain:u}}function ae(){s=o.createGain(),s.gain.value=f?hT:0,s.connect(o.destination),c=o.createBiquadFilter(),c.type=`lowpass`,c.frequency.value=18e3,c.Q.value=.7,c.connect(s);let e=QT(o,_T,i);ee=e,l={windLow:ie(e,{type:`bandpass`,freq:130,Q:.8,rate:.83}),windHigh:ie(e,{type:`bandpass`,freq:900,Q:.55,rate:1}),rustle:ie(e,{type:`bandpass`,freq:3e3,Q:.5,rate:1.19}),waterLow:ie(e,{type:`lowpass`,freq:420,Q:.9,rate:.91}),waterHigh:ie(e,{type:`bandpass`,freq:2400,Q:.45,rate:1.07}),rain:ie(e,{type:`bandpass`,freq:1800,Q:.4,rate:1.13})},ne.started=!0}function oe(e,t){let n=u.sampleGroundHeight;if(!n)return 0;let r=GT,i=n(e+r,t)-n(e-r,t),a=n(e,t+r)-n(e,t-r);return!Number.isFinite(i)||!Number.isFinite(a)?0:Math.atan(Math.hypot(i,a)/(2*r))*180/Math.PI}function se(e,t,n,r){let i=u.sampleGroundHeight;if(!(r>0))return 0;let a=0;if(i){let n=GT,r=(i(e,t-n)-i(e,t+n))/(2*n);Number.isFinite(r)&&(a=r/Math.hypot(1,r))}return Uv({elevM:n,aspectZ:a,level:r})}function ce(e,t,n,r,i,a){return se(e,t,n,i)>zT||n>HT?`snow`:a>BT?`wet`:r>VT?`forest`:n>UT||oe(e,t)>WT?`scree`:`grass`}function F(e,t,n,r,{freqMul:a=1,durMul:s=1,rate:l=1}={}){let u=e.durS*s,d=o.createBufferSource();d.buffer=ee,d.playbackRate.value=l;let f=o.createBiquadFilter();f.type=e.type,f.frequency.value=e.freq*a,f.Q.value=e.Q;let p=o.createGain(),m=Math.max(t,1e-4);p.gain.setValueAtTime(1e-4,r),p.gain.exponentialRampToValueAtTime(m,r+e.attackS),p.gain.exponentialRampToValueAtTime(1e-4,r+u);let h=o.createStereoPanner();return h.pan.value=n,d.connect(f).connect(p).connect(h).connect(c),d.start(r,i()*Math.max(.1,_T-u-.1),u+.02),d.onended=()=>{d.disconnect(),f.disconnect(),p.disconnect(),h.disconnect()},d}let le=[];function ue(e){for(let t of le)if(!(t.at<=e)){for(let n of t.srcs)n.stop(e),n.onended?.(),n.onended=null;te--}le.length=0}function de(e,t){let n=RT[e];if(!n||!ee)return;M^=1;let r=M?LT:-.12,a=FT*n.gain*(.85+.3*i()),o=[F(n,a,r,t,{freqMul:.9+.2*i(),durMul:.9+.2*i(),rate:.9+.25*i()})];for(let e=0;e<(n.grains??0);e++)o.push(F(n,a*n.grainGain*(.4+.6*i()),r+(i()-.5)*.3,t+.02+i()*.09,{freqMul:1.1+.5*i(),durMul:.35,rate:1+.5*i()}));le.push({at:t,srcs:o}),te++}function fe(e,t,n,r,a,o,s){let c=ge();if(!s)return ue(c),j=c+.06,N=null,null;le.length&&(le=le.filter(e=>e.at>c));let l=ce(e,t,n,r,a,o);for(N=l,j<c&&(j=c+.06);j<c+IT;)de(l,j),j+=1/jT*(1+(i()-.5)*2*MT);return l}function pe(){if(!o){let e=window.AudioContext??window.webkitAudioContext;if(!e)return!1;o=new e}return l||ae(),!o.startRendering&&o.state===`suspended`&&o.resume(),!0}function me(e){f=!!e,ne.enabled=f,f&&pe(),s&&s.gain.setTargetAtTime(f?hT:0,o.currentTime,yT)}function he(e,t,n){let r=JT(1300,3300,n),i=0,a=u.sampleGroundHeight;if(a){let r=0,o=0;for(let[n,i]of[[90,0],[-90,0],[0,90],[0,-90]]){let s=a(e+n,t+i);Number.isFinite(s)&&(r+=s,o++)}o&&(i=JT(0,35,n-r/o))}return{altitude:r,exposure:i}}function ge(){return typeof o.startRendering==`function`?(D??=o.currentTime,D+E):o.currentTime}function _e(e,t,n){let r=XT(t,n,e.salt);if(r()>e.presence)return null;let i=(t+r())*e.cellM,a=(n+r())*e.cellM,o=u.sampleGroundHeight;if(!o)return null;let s=o(i,a),c=e.habitat;if(!Number.isFinite(s)||s<c.elevMin||s>c.elevMax)return null;let l=qT(u.canopyAt?.(i,a)??0,0,1);return c.canopyMin!=null&&l<c.canopyMin||c.canopyMax!=null&&l>c.canopyMax?null:{x:i,z:a,rnd:r,nextIn:r()*e.everyS[1]}}function ve(e,t){if(u.sampleGroundHeight)for(let n=0;n<DT.length;n++){let r=DT[n],i=w[n],a=r.earshotM+r.cellM,o=Math.ceil(a/r.cellM),s=Math.floor(e/r.cellM),c=Math.floor(t/r.cellM),l=new Set;for(let n=c-o;n<=c+o;n++)for(let c=s-o;c<=s+o;c++){let o=(c+.5)*r.cellM-e,s=(n+.5)*r.cellM-t;if(Math.hypot(o,s)>a)continue;let u=`${c}:${n}`;l.add(u),i.has(u)||i.set(u,_e(r,c,n))}for(let e of i.keys())l.has(e)||i.delete(e)}}function ye(e,t,n,r){let i=we(t.x,t.z,n),a=e.gain*r*(1-n/e.earshotM)**1.5;if(a<.001)return!1;let o=t.rnd,s=e.repeat?e.repeat[0]+Math.floor(o()*(e.repeat[1]-e.repeat[0]+1)):1,c=ge()+.01+o()/gT;for(let t=0;t<s;t++){for(let[t,n,r]of e.phrase)Te(e.voice,a*(.86+.14*o()),i,c,t*(.995+.01*o()),n),c+=r;e.repeatGapS&&(c+=ZT(o,e.repeatGapS))}return O++,k[e.name]++,!0}function be(e,t,n,r,i){let a=qT(1-kT*r,.1,1),o=JT(.25,.7,A),s=1-AT*i,c=0;for(let r=0;r<DT.length;r++){let i=DT[r],l=(i.nocturnal?o:1-o)*s;for(let o of w[r].values()){if(!o||(c++,o.nextIn-=e,o.nextIn>0)||(o.nextIn=ZT(o.rnd,i.everyS),o.rnd()>l))continue;let r=Math.hypot(o.x-t,o.z-n);r>i.earshotM||ye(i,o,r,a)}}return c}function xe(e,t,n,r){let a=t.position.x,s=t.position.y,_=t.position.z;h-=e,h<=0&&(m=.15+.85*i(),h=1.5+3.5*i()),p+=(m-p)*(1-Math.exp(-e/1.2)),g=(g+e*.9)%(Math.PI*2);let y=u.sampleGroundHeight?.(a,_),b=Number.isFinite(y)?y:s,x=qT(u.canopyAt?.(a,_)??0,0,1),S=n?.mod??{},C=qT(S.rain??0,0,1),w=qT(S.snow??0,0,1),{altitude:D,exposure:k}=he(a,_,b),ee=JT(2,60,Math.max(0,s-b)),j=JT(6,70,v)*(.3+.45*ee),M=1-.55*x,N=qT((.16+.52*D+.32*k)*M+.55*C+j,0,1.25),P=0,ie=null;if(f){E+=e,T+=e,T>=OT&&(T=0,ve(a,_)),P=be(e,a,_,qT(N,0,1),C);let t=r?.mode===`walk`&&(r.travelMps??0)>NT;ie=fe(a,_,b,x,w,S.wet??0,t)}let ae=0,oe=0,se=d?.query(a,_)??null;if(se)for(let[e,t]of Object.entries(bT)){let{distanceM:n,strength:r}=se[e];if(!(n<t.radiusM))continue;let i=n/t.radiusM,a=(1-i)**1.8*r*t.gain,o=a*(1-.55*i),s=e===`lake`?.75+.35*Math.sin(g):1;ae+=t.low*a*s,oe+=t.high*o*s}let ce={windLow:.5*N*(.55+.55*p),windHigh:.3*N**1.25*(.35+.85*p),rustle:.5*x*(.2+.9*N)*(.3+.9*p),waterLow:qT(ae,0,1),waterHigh:qT(oe,0,1),rain:.55*C*(1+.5*x)};for(let[e,t]of Object.entries(ce))re(l[e].gain.gain,t);re(l.windLow.filter.frequency,110+60*p),re(l.windHigh.filter.frequency,700+900*p),re(c.frequency,18e3-12500*w),Object.assign(ne,{strength:N,altitude:D,exposure:k,canopy:x,gust:p,rain:C,snow:w,speedMps:v,water:se,gains:ce,night:A,singers:P,songs:O,surface:ie,steps:te,clockSkew:ge()-o.currentTime})}function Se(e,t,n=null,r=null,i=null){if(!l||!t)return;P=t,A=qT(r?.night??0,0,1);let a=t.position.x,o=t.position.y,s=t.position.z;if(y!=null&&e>1e-4){let t=Math.hypot(a-y,o-b,s-x)/e;t>PT?v=0:v+=(t-v)*(1-Math.exp(-e/.3))}if(y=a,b=o,x=s,_+=e,_<1/gT)return;let c=_;_=0,xe(c,t,n,i)}function Ce({species:e,x:t,z:n}={}){if(!l||!f||!P)return 0;let r=CT[e];if(!r)return 0;let a=P.position.x,s=P.position.z,c=Math.hypot(t-a,n-s);if(c>r.earshotM||o.currentTime-S<TT)return 0;S=o.currentTime,C++;let u=we(t,n,c),d=r.gain*(1-c/r.earshotM)**1.5,p=r.notesMin+Math.floor(i()*(r.notesMax-r.notesMin+1)),m=o.currentTime+.01;for(let e=0;e<p;e++)Te(r,d*(e===0?1:.7+.3*i()),u,m,.97+.06*i()),m+=r.gapS[0]+(r.gapS[1]-r.gapS[0])*i();return p}function we(e,t,n){if(!P)return 0;let r=0,i=-1;if(P.getWorldDirection){P.getWorldDirection(KT);let e=Math.hypot(KT.x,KT.z)||1;r=KT.x/e,i=KT.z/e}let a=P.position.x,o=P.position.z,s=Math.max(n,.001);return qT((e-a)/s*-i+(t-o)/s*r,-1,1)}function Te(e,t,n,r,i=1,a=null){let s=a??e.durS,l=e.f0*i,u=e.f1*i,d=o.createOscillator();d.type=e.wave??`triangle`,d.frequency.setValueAtTime(l,r),d.frequency.exponentialRampToValueAtTime(u,r+s);let f=o.createBiquadFilter();f.type=`bandpass`,f.frequency.value=(l+u)/2,f.Q.value=e.bandQ;let p=[],m=f;if(e.rattleHz){let t=e.rattleDepth??.55,n=o.createGain();n.gain.value=1-t;let i=o.createOscillator();i.type=`square`,i.frequency.value=e.rattleHz;let a=o.createGain();a.gain.value=t,i.connect(a).connect(n.gain),i.start(r),i.stop(r+s+.02),f.connect(n),m=n,p.push(n,i,a)}let h=o.createGain(),g=Math.max(t,2e-4);h.gain.setValueAtTime(1e-4,r),h.gain.exponentialRampToValueAtTime(g,r+wT),h.gain.exponentialRampToValueAtTime(g*.8,r+s*.7),h.gain.exponentialRampToValueAtTime(1e-4,r+s);let _=o.createStereoPanner();_.pan.value=n,d.connect(f),m.connect(h).connect(_).connect(c),d.start(r),d.stop(r+s+.02),d.onended=()=>{d.disconnect(),f.disconnect(),h.disconnect(),_.disconnect();for(let e of p)e.disconnect()}}return{start:pe,setEnabled:me,get enabled(){return f},toggle(){return me(!f),f},setSamplers(e){u={...u,...e};for(let e of w)e.clear();T=OT},setWater(e){return d=e?eE(e):null,d},update:Se,call:Ce,get diag(){return ne},get callsPlayed(){return C},get songsPlayed(){return O},get stepsPlayed(){return te},get surface(){return N},get surfaces(){return Object.keys(RT)},get songsBySpecies(){return{...k}},get songbirds(){return DT.map(e=>e.name)},get context(){return o}}}var nE=1950,rE=9e3,iE={value:1},aE={value:null},oE=null,sE=null,cE=[{name:`rayleighZenithLength`,expect:8400,tol:.2},{name:`mieZenithLength`,expect:1250,tol:.2}],lE=!1;function uE(){if(lE)return oE;let e=Zu.SkyShader,t={};for(let{name:n,expect:r,tol:i}of cE){let a=RegExp(`const\\s+float\\s+${n}\\s*=\\s*([^;]+);`),o=e.fragmentShader.match(a);if(!o)throw Error(`src/sky.js: could not find "const float ${n}" in three's Sky shader. The addon has been reformatted or renamed by a three.js upgrade, and the altitude patch would silently do nothing - which looks identical to a weak effect. Re-read node_modules/three/examples/jsm/objects/Sky.js.`);let s=Number.parseFloat(o[1]);if(!Number.isFinite(s)||s<=0)throw Error(`src/sky.js: ${n} parsed as ${o[1]}, which is not a usable length.`);if(Math.abs(s-r)>r*i)throw Error(`src/sky.js: ${n} is ${s} m, but this module assumes ~${r} m (the atmospheric scale height it stands for). Re-derive the exponent before changing this check - see the header.`);t[n]=s,e.fragmentShader=e.fragmentShader.replace(a,`uniform float ${n};`),e.uniforms[n]={value:s}}return lE=!0,oE=t,sE=Object.entries(t),oE}function dE(e){let t=Math.min(rE,Math.max(0,e))-nE;return t*(t>0?iE.value:1)}function fE(e,t){if(!sE)throw Error(`src/sky.js: installSkyAltitude() has not run yet.`);let n=dE(aE.value??t),r=e.material.uniforms;for(let e=0;e<sE.length;e++){let[t,i]=sE[e];r[t].value=i*Math.exp(-n/i)}}var pE=[{key:`dawn`,label:`Dawn`,sunElev:6,sunAzim:95,turbidity:7,rayleigh:2.6,mieC:.006,mieG:.86,exposure:.95,fog:14927016,stars:.25,haze:16e-6,valleyFog:.85,fogTop:1100,glow:.5,glowColor:16758392,sunColor:16768964,sunIntensity:1,ambientColor:9412809,ambientIntensity:.35},{key:`day`,label:`Midday`,sunElev:25,sunAzim:155,turbidity:4,rayleigh:1.6,mieC:.004,mieG:.85,exposure:.75,fog:13622508,stars:0,haze:11e-6,valleyFog:0,fogTop:1100,glow:.08,glowColor:16773336,sunColor:16777215,sunIntensity:1.8,ambientColor:16777215,ambientIntensity:.6},{key:`golden`,label:`Golden hour`,sunElev:11,sunAzim:262,turbidity:4.5,rayleigh:3.2,mieC:.006,mieG:.88,exposure:.95,fog:15519654,stars:0,haze:15e-6,valleyFog:.12,fogTop:1100,glow:.7,glowColor:16752727,sunColor:16758903,sunIntensity:1.1,ambientColor:16764588,ambientIntensity:.4},{key:`dusk`,label:`Dusk`,sunElev:1.5,sunAzim:285,turbidity:5,rayleigh:3.8,mieC:.009,mieG:.9,exposure:.75,fog:9472168,stars:.55,haze:14e-6,valleyFog:.2,fogTop:1100,glow:.3,glowColor:14583392,sunColor:10129353,sunIntensity:.45,ambientColor:5925529,ambientIntensity:.3},{key:`night`,label:`Night`,sunElev:-10,sunAzim:0,turbidity:2,rayleigh:.6,mieC:.002,mieG:.8,exposure:.55,fog:922399,stars:1,haze:8e-6,valleyFog:.12,fogTop:1100,glow:.05,glowColor:10335453,sunColor:9413853,sunIntensity:.18,ambientColor:3358827,ambientIntensity:.15,lightElev:38,lightAzim:215}],mE=[`turbidity`,`rayleigh`,`mieC`,`mieG`,`exposure`,`stars`,`haze`,`valleyFog`,`fogTop`,`glow`,`sunIntensity`,`ambientIntensity`],hE=5e4,gE={cover:.12,dark:.06,hazeMul:1,vfAdd:0,exposureMul:1,grey:0,glowMul:1,starsMul:1},_E={value:1};function vE(e,t){return new U().setFromSphericalCoords(1,Dt.degToRad(90-e),Dt.degToRad(t))}function yE(e){return{sun:vE(e.sunElev,e.sunAzim),light:vE(e.lightElev??Math.max(e.sunElev,4),e.lightAzim??e.sunAzim),fogColor:new G(e.fog),glowColor:new G(e.glowColor),sunColor:new G(e.sunColor),ambientColor:new G(e.ambientColor),turbidity:e.turbidity,rayleigh:e.rayleigh,mieC:e.mieC,mieG:e.mieG,exposure:e.exposure,stars:e.stars,haze:e.haze,valleyFog:e.valleyFog,fogTop:e.fogTop,glow:e.glow,sunIntensity:e.sunIntensity,ambientIntensity:e.ambientIntensity}}function bE(e,t,n,r){r.sun.copy(e.sun).lerp(t.sun,n).normalize(),r.light.copy(e.light).lerp(t.light,n).normalize(),r.fogColor.copy(e.fogColor).lerp(t.fogColor,n),r.glowColor.copy(e.glowColor).lerp(t.glowColor,n),r.sunColor.copy(e.sunColor).lerp(t.sunColor,n),r.ambientColor.copy(e.ambientColor).lerp(t.ambientColor,n);for(let i of mE)r[i]=e[i]+(t[i]-e[i])*n}var xE=class{constructor({renderer:e,scene:t,sky:n,sunLight:r,ambientLight:i}){this.renderer=e,this.scene=t,this.sky=n,this.sunLight=r,this.ambientLight=i,this.weather=null,this.stars=SE(),t.add(this.stars),this._effFog=new G,this._grey=new G,this.fraction=.15,this.state=yE(pE[0]),this._a=yE(pE[0]),this._b=yE(pE[1]),this.setTime(this.fraction)}setTime(e){this.fraction=(e%1+1)%1;let t=pE.length,n=this.fraction*t,r=Math.floor(n)%t,i=(r+1)%t,a=n-Math.floor(n);Object.assign(this._a,yE(pE[r])),Object.assign(this._b,yE(pE[i])),bE(this._a,this._b,a,this.state),this.label=a<.5?pE[r].label:pE[i].label;let o=pE.findIndex(e=>e.key===`night`);this.night=(r===o?1-a:0)+(i===o?a:0),this.applyState()}applyState(){let e=this.state,t=this.weather?.mod??gE,n=this.sky.material.uniforms;n.sunPosition.value.copy(e.sun),n.turbidity.value=e.turbidity,n.rayleigh.value=e.rayleigh,n.mieCoefficient.value=e.mieC,n.mieDirectionalG.value=e.mieG,n.cloudCoverage.value=t.cover,n.cloudDensity.value=.5,this.renderer.toneMappingExposure=e.exposure*t.exposureMul,this._effFog.copy(e.fogColor).lerp(this._grey.setScalar((e=>e.r*.299+e.g*.587+e.b*.114)(e.fogColor)*.97),t.grey),this.scene.fog.color.copy(this._effFog),this.sunLight.position.copy(e.light).multiplyScalar(hE),this.sunLight.color.copy(e.sunColor),this.sunLight.intensity=e.sunIntensity*(1-t.dark*.85),this.ambientLight.color.copy(e.ambientColor),this.ambientLight.intensity=e.ambientIntensity*(1-t.dark*.5);let r=xv.uniforms;r.uAtmoSunDir.value.copy(e.light),r.uAtmoGlowColor.value.copy(e.glowColor),r.uAtmoGlow.value=e.glow*t.glowMul,r.uAtmoHaze.value=e.haze*t.hazeMul*_E.value,r.uAtmoValleyFog.value=e.valleyFog*32e-5+t.vfAdd,r.uAtmoFogTop.value=e.fogTop,r.uAtmoSnow.value=t.snow??0,r.uAtmoWet.value=t.wet??0,r.uAtmoFogColor.value.copy(this._effFog),this.stars.material.opacity=e.stars*t.starsMul,this.stars.visible=this.stars.material.opacity>.01,this.weather?.applyLight(this._effFog)}};function SE(){let e=16e4,t=3200,n=new Float32Array(t*3),r=new Float32Array(t*3),i=0;for(let a=0;a<t;a++){let o;if(a<t*.45){let e=Math.random()*Math.PI*2,t=(Math.random()-.5)*.5*(Math.random()<.7?1:2.5);o=new U(Math.cos(e),t,Math.sin(e)).normalize(),o.applyAxisAngle(new U(1,0,0),1)}else o=new U(Math.random()*2-1,Math.random(),Math.random()*2-1).normalize();o.y<.02&&(o.y=.02+Math.random()*.1),o.normalize(),n[i]=o.x*e,n[i+1]=o.y*e,n[i+2]=o.z*e;let s=.4+Math.random()**3*.6,c=Math.random();r[i]=s*(c>.8?1:.85+c*.15),r[i+1]=s*.92,r[i+2]=s*(c<.2?1:.9),i+=3}let a=new kr;a.setAttribute(`position`,new mr(n,3)),a.setAttribute(`color`,new mr(r,3));let o=new Zi({size:2.2,sizeAttenuation:!1,vertexColors:!0,transparent:!0,opacity:0,depthWrite:!1,fog:!1,blending:2});o.toneMapped=!1;let s=new na(a,o);return s.visible=!1,s.frustumCulled=!1,s}var CE=[{key:`clear`,label:`Clear skies`,cover:.12,dark:.06,hazeMul:1,vfAdd:0,exposureMul:1,grey:0,glowMul:1,starsMul:1,snow:0,wet:0,rain:0,wind:.3},{key:`clouds`,label:`Drifting clouds`,cover:.52,dark:.26,hazeMul:1.35,vfAdd:0,exposureMul:.95,grey:.22,glowMul:.6,starsMul:.3,snow:0,wet:0,rain:0,wind:.55},{key:`storm`,label:`Rainstorm`,cover:1,dark:.62,hazeMul:3.2,vfAdd:1e-4,exposureMul:.76,grey:.78,glowMul:0,starsMul:0,snow:0,wet:1,rain:1,wind:1},{key:`snow`,label:`Snowfall`,cover:.95,dark:.3,hazeMul:2.4,vfAdd:7e-5,exposureMul:.9,grey:.6,glowMul:.05,starsMul:0,snow:1,wet:0,rain:0,wind:.7}],wE=CE.map(e=>e.key),TE=[`cover`,`dark`,`hazeMul`,`vfAdd`,`exposureMul`,`grey`,`glowMul`,`starsMul`,`wet`,`rain`,`wind`],EE=6,DE=12,OE=new G(1,1,1),kE=class{constructor(e,{worldWidth:t,worldDepth:n}){this.index=0,this.mod={...CE[0],snow:0,snowFall:0},this.from={...this.mod},this.to=CE[0],this.t=1,this.time={value:0},this._snowAccum=0,this.clouds=AE(this.time,t,n),e.add(this.clouds),this.precip=jE(this.time),e.add(this.precip)}get current(){return CE[this.index].key}get label(){return CE[this.index].label}set(e){return this.index=(e%CE.length+CE.length)%CE.length,this.from={...this.mod},this.to=CE[this.index],this.t=0,CE[this.index].label}cycle(){return this.set(this.index+1)}update(e,t){if(this.time.value+=e,this.t<1){this.t=Math.min(1,this.t+e/4);let t=this.t*this.t*(3-2*this.t);for(let e of TE)this.mod[e]=this.from[e]+(this.to[e]-this.from[e])*t;this.mod.snowFall=this.from.snowFall+(this.to.snow-this.from.snowFall)*t}let n=this.to.snow>this._snowAccum?EE:DE;this._snowAccum+=(this.to.snow-this._snowAccum)*(1-Math.exp(-e/n)),this.mod.snow=this._snowAccum;let r=this.clouds.material.uniforms;r.uCover.value=this.mod.cover,r.uDark.value=this.mod.dark;let i=this.precip.material.uniforms,a=Math.max(this.mod.rain,this.mod.snowFall);i.uIntensity.value=a,i.uSnowMix.value=this.mod.snowFall/Math.max(this.mod.rain+this.mod.snowFall,1e-4),this.precip.visible=a>.02,t&&this.precip.position.copy(t.position)}applyLight(e){let t=this.clouds.material.uniforms;t.uLight.value.copy(e).lerp(OE,.55).multiplyScalar(1-this.mod.dark*.2),t.uShade.value.copy(e).multiplyScalar(.52-this.mod.dark*.22),this.precip.material.uniforms.uColor.value.copy(e).lerp(OE,.45)}};function AE(e,t,n){let r=t/2,i=n/2,a=new eo(t*1.3,n*1.3);a.rotateX(-Math.PI/2);let o=new mo({transparent:!0,depthWrite:!1,side:2,uniforms:{uTime:e,uCover:{value:.12},uDark:{value:.06},uLight:{value:new G(1,1,1)},uShade:{value:new G(.6,.62,.66)},uHalfExtent:{value:new H(r,i)},...xv.uniforms},vertexShader:`
      varying vec3 vWorld;
      void main() {
    ...
    `});o.toneMapped=!1;let s=new _i(a,o);return s.position.y=4600,s.renderOrder=1,s.frustumCulled=!1,s}function jE(e){let t=6e3,n=new Float32Array(t*4);for(let e=0;e<n.length;e++)n[e]=Math.random();let r=new kr;r.setAttribute(`position`,new mr(new Float32Array(t*3),3)),r.setAttribute(`aRand`,new mr(n,4));let i=new mo({transparent:!0,depthWrite:!1,uniforms:{uTime:e,uSnowMix:{value:0},uIntensity:{value:0},uColor:{value:new G(.8,.85,.9)},uTexRain:{value:ME()},uTexSnow:{value:NE()}},vertexShader:`
    ...
    `});i.toneMapped=!1;let a=new na(r,i);return a.frustumCulled=!1,a.renderOrder=4,a.visible=!1,a}function ME(){let e=document.createElement(`canvas`);e.width=e.height=32;let t=e.getContext(`2d`),n=t.createLinearGradient(0,0,0,32);return n.addColorStop(0,`rgba(255,255,255,0)`),n.addColorStop(.4,`rgba(255,255,255,0.9)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(13,0,6,32),new aa(e)}function NE(){let e=document.createElement(`canvas`);e.width=e.height=32;let t=e.getContext(`2d`),n=t.createRadialGradient(16,16,0,16,16,15);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.55,`rgba(255,255,255,0.7)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,32,32),new aa(e)}var PE=[`N`,`NE`,`E`,`SE`,`S`,`SW`,`W`,`NW`],FE=new U;function IE(e){return e.getWorldDirection(FE),(Math.atan2(FE.x,-FE.z)*180/Math.PI+360)%360}function LE(e){return PE[Math.round(e/45)%8]}function RE(e){return e.getWorldDirection(FE),Math.asin(Dt.clamp(FE.y,-1,1))*180/Math.PI}function zE(e,t,n=new U){let r=e*Math.PI/180,i=t*Math.PI/180,a=Math.cos(i);return n.set(Math.sin(r)*a,Math.sin(i),-Math.cos(r)*a)}function BE(e,t,n){let r=null,i=1/0;for(let a of n){let n=a.local.x-e,o=a.local.z-t,s=n*n+o*o;s<i&&(i=s,r=a)}return r?{poi:r,distanceM:Math.sqrt(i)}:null}var VE=new cn(0,0,0,`YXZ`),HE=new U,UE={type:`change`},WE={type:`lock`},GE={type:`unlock`},KE=.002,qE=Math.PI/2,JE=class extends Ms{constructor(e,t=null){super(e,t),this.isLocked=!1,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.pointerSpeed=1,this._onMouseMove=YE.bind(this),this._onPointerlockChange=XE.bind(this),this._onPointerlockError=ZE.bind(this),this.domElement!==null&&this.connect(this.domElement)}connect(e){super.connect(e),this.domElement.ownerDocument.addEventListener(`mousemove`,this._onMouseMove),this.domElement.ownerDocument.addEventListener(`pointerlockchange`,this._onPointerlockChange),this.domElement.ownerDocument.addEventListener(`pointerlockerror`,this._onPointerlockError)}disconnect(){this.domElement.ownerDocument.removeEventListener(`mousemove`,this._onMouseMove),this.domElement.ownerDocument.removeEventListener(`pointerlockchange`,this._onPointerlockChange),this.domElement.ownerDocument.removeEventListener(`pointerlockerror`,this._onPointerlockError)}dispose(){this.disconnect()}getDirection(e){return e.set(0,0,-1).applyQuaternion(this.object.quaternion)}moveForward(e){if(this.enabled===!1)return;let t=this.object;HE.setFromMatrixColumn(t.matrix,0),HE.crossVectors(t.up,HE),t.position.addScaledVector(HE,e)}moveRight(e){if(this.enabled===!1)return;let t=this.object;HE.setFromMatrixColumn(t.matrix,0),t.position.addScaledVector(HE,e)}lock(e=!1){this.domElement.requestPointerLock({unadjustedMovement:e})}unlock(){this.domElement.ownerDocument.exitPointerLock()}};function YE(e){if(this.enabled===!1||this.isLocked===!1)return;let t=this.object;VE.setFromQuaternion(t.quaternion),VE.y-=e.movementX*KE*this.pointerSpeed,VE.x-=e.movementY*KE*this.pointerSpeed,VE.x=Math.max(qE-this.maxPolarAngle,Math.min(qE-this.minPolarAngle,VE.x)),t.quaternion.setFromEuler(VE),this.dispatchEvent(UE)}function XE(){this.domElement.ownerDocument.pointerLockElement===this.domElement?(this.dispatchEvent(WE),this.isLocked=!0):(this.dispatchEvent(GE),this.isLocked=!1)}function ZE(){console.error(`THREE.PointerLockControls: Unable to use Pointer Lock API`)}var QE=1.7,$E=4,eD=60,tD=2.5,nD=Math.PI/3,rD=.002,iD=.045,aD=Math.PI/2-.002,oD=120,sD=8,cD=.5,lD=class{constructor(e=3){this._windowS=e,this._current=0,this._previous=0,this._age=0}add(e){e>this._current&&(this._current=e)}tick(e){this._age+=e,this._age>=this._windowS&&(this._age=0,this._previous=this._current,this._current=0)}get value(){return Math.max(this._current,this._previous)}},uD=new Set([`KeyW`,`KeyA`,`KeyS`,`KeyD`,`KeyQ`,`KeyE`,`Space`,`KeyC`,`ShiftLeft`,`ShiftRight`]),dD=new U(0,1,0),fD=.5,pD=class{constructor(e,t){this.camera=e,this.domElement=t,this.mode=`walk`,this._enabled=!0,this.getGroundHeight=null,this.getFade=null,this.travelMps=0,this.plc=new JE(e,t),this.plc.pointerSpeed=0,this._keys=new Set,this._dir=new U,this._euler=new cn(0,0,0,`YXZ`),this._pendingYaw=0,this._pendingPitch=0,this.lookDiag={eventPx:new lD,eventsPerFrame:new lD,frameMs:new lD,stepDeg:new lD,spikePx:new lD},this._eventsSinceFrame=0,this._typicalPx=0,this._spikesRejected=0,t.addEventListener(`click`,()=>{document.pointerLockElement!==t&&t.requestPointerLock()}),t.ownerDocument.addEventListener(`mousemove`,e=>{if(!this._enabled||!this.plc.isLocked)return;let t=Math.hypot(e.movementX,e.movementY);if(this.lookDiag.eventPx.add(t),this._eventsSinceFrame+=1,t>Math.max(oD,sD*this._typicalPx)){this._spikesRejected+=1,this.lookDiag.spikePx.add(t);return}this._typicalPx+=(t-this._typicalPx)*.25,this._pendingYaw-=e.movementX*rD,this._pendingPitch-=e.movementY*rD}),window.addEventListener(`keydown`,e=>{if(!hD(document.activeElement)){if(e.code===`KeyF`){e.preventDefault(),this.mode=this.mode===`walk`?`fly`:`walk`;return}uD.has(e.code)&&(e.preventDefault(),this._keys.add(e.code))}}),window.addEventListener(`keyup`,e=>this._keys.delete(e.code))}get locked(){return this.plc.isLocked}get spikesRejected(){return this._spikesRejected}get enabled(){return this._enabled}set enabled(e){this._enabled=e,this.plc.enabled=e,this._pendingYaw=0,this._pendingPitch=0}_applyLook(e){if(this._pendingYaw===0&&this._pendingPitch===0)return;let t=1-Math.exp(-e/iD),n=this._pendingYaw*t,r=this._pendingPitch*t;this._pendingYaw-=n,this._pendingPitch-=r,this._euler.setFromQuaternion(this.camera.quaternion);let i=this._euler.x;this._euler.y+=n,this._euler.x=Math.max(-aD,Math.min(aD,this._euler.x+r)),this.camera.quaternion.setFromEuler(this._euler),this.lookDiag.stepDeg.add(Math.abs(this._euler.x-i)*180/Math.PI),Math.abs(this._pendingYaw)<1e-5&&(this._pendingYaw=0),Math.abs(this._pendingPitch)<1e-5&&(this._pendingPitch=0)}update(e){this.travelMps=0,this.lookDiag.frameMs.add(e*1e3),this.lookDiag.eventsPerFrame.add(this._eventsSinceFrame),this._eventsSinceFrame=0;for(let t of Object.values(this.lookDiag))t.tick(e);if(this._typicalPx*=Math.exp(-e/cD),!this.enabled)return;this._applyLook(e);let t=this._keys.has(`ShiftLeft`)||this._keys.has(`ShiftRight`)?tD:1,n=(this.mode===`walk`?$E:eD)*t*e,r=!!this._keys.has(`KeyA`)-+!!this._keys.has(`KeyD`);r!==0&&this.camera.rotateOnWorldAxis(dD,r*nD*e);let i=!!this._keys.has(`KeyE`)-+!!this._keys.has(`KeyQ`),a=!!this._keys.has(`KeyW`)-+!!this._keys.has(`KeyS`),o=Math.hypot(i,a)||1;i/=o,a/=o;let s=this.camera.position.x,c=this.camera.position.z;if(this.mode===`fly`)this.plc.getDirection(this._dir),this.camera.position.addScaledVector(this._dir,a*n),this.plc.moveRight(i*n),this._keys.has(`Space`)&&(this.camera.position.y+=n),this._keys.has(`KeyC`)&&(this.camera.position.y-=n);else{this.plc.moveForward(a*n),this.plc.moveRight(i*n);let e=this.getGroundHeight?.(this.camera.position.x,this.camera.position.z);e!=null&&(this.camera.position.y=e+QE)}if(this.getFade&&this.getFade(this.camera.position.x,this.camera.position.z)>fD){let e=this.camera.position.x,t=this.camera.position.z;if(this.getFade(e,c)<=fD?this.camera.position.z=c:this.getFade(s,t)<=fD?this.camera.position.x=s:(this.camera.position.x=s,this.camera.position.z=c),this.mode===`walk`){let e=this.getGroundHeight?.(this.camera.position.x,this.camera.position.z);e!=null&&(this.camera.position.y=e+QE)}}e>1e-4&&(this.travelMps=Math.hypot(this.camera.position.x-s,this.camera.position.z-c)/e)}},mD=new Set([`text`,`search`,`url`,`email`,`tel`,`password`,`number`,`date`,`time`,`datetime-local`,`month`,`week`]);function hD(e){return e?e.isContentEditable||e.tagName===`TEXTAREA`?!0:e.tagName===`INPUT`&&mD.has(e.type):!1}var gD=1,_D=`pngp.viewer.v${gD}`,vD=5,yD=[`walk`,`fly`];function bD(e){let t=Number(e);return Number.isFinite(t)?t:null}function xD(e){return(e%360+360)%360}function SD(e,t,n){return Math.min(n,Math.max(t,e))}function CD(e){if(!e||typeof e!=`object`)return null;let t=bD(e.lat),n=bD(e.lon),r=bD(e.alt),i=bD(e.heading),a=bD(e.pitch);if(t==null||n==null||r==null||i==null||a==null||Math.abs(t)>90||Math.abs(n)>180)return null;let o=bD(e.time),s={lat:t,lon:n,alt:SD(r,-500,2e4),heading:xD(i),pitch:SD(a,-90,90),mode:yD.includes(e.mode)?e.mode:`walk`,time:o==null?null:SD(o,0,1),sky:wE.includes(e.sky)?e.sky:null};typeof e.sound==`boolean`&&(s.sound=e.sound);let c=bD(e.terrain);c!=null&&(s.terrain=SD(Math.round(c),0,9));let l=bD(e.models);l!=null&&(s.models=SD(Math.round(l),0,1));let u=bD(e.cover);return u!=null&&(s.cover=SD(u,0,1)),s}function wD(e){let t=CD(e);if(!t)return``;let n=[`at=${t.lat.toFixed(vD)},${t.lon.toFixed(vD)},${Math.round(t.alt)}`,`look=${Math.round(t.heading)},${Math.round(t.pitch)}`,`mode=${t.mode}`];return t.time!=null&&n.push(`time=${t.time.toFixed(3)}`),t.sky&&n.push(`sky=${t.sky}`),`#${n.join(`&`)}`}function TD(e){if(!e||typeof e!=`string`)return null;let t=new URLSearchParams(e.replace(/^#/,``)),n=(t.get(`at`)??``).split(`,`),r=(t.get(`look`)??``).split(`,`);return n.length<3?null:CD({lat:n[0],lon:n[1],alt:n[2],heading:r[0]??0,pitch:r[1]??0,mode:t.get(`mode`)??`walk`,time:t.get(`time`),sky:t.get(`sky`)})}function ED(){try{let e=localStorage.getItem(_D);if(!e)return null;let t=JSON.parse(e);if(t?.v!==gD)return null;let n=CD(t.state);return n||OD(),n}catch{return null}}function DD(e){let t=CD(e);if(!t)return!1;try{return localStorage.setItem(_D,JSON.stringify({v:gD,state:t})),!0}catch{return!1}}function OD(){try{return localStorage.removeItem(_D),!0}catch{return!1}}wv(),uE();var kD=new Fn;kD.fog=new Pn(10471912,2e4,14e4);var $=new $o(60,window.innerWidth/window.innerHeight,.1,2e5);$.position.set(0,3e3,0);var AD=new Xu({antialias:!0,logarithmicDepthBuffer:!0});AD.setSize(window.innerWidth,window.innerHeight),AD.setPixelRatio(window.devicePixelRatio),AD.toneMapping=4,document.body.appendChild(AD.domElement);var jD=new id;jD.setSize(window.innerWidth,window.innerHeight),jD.domElement.style.position=`absolute`,jD.domElement.style.top=`0`,jD.domElement.style.pointerEvents=`none`,document.body.appendChild(jD.domElement);var MD=new pD($,AD.domElement),ND=tE(),PD=TD(window.location.hash),FD=ED(),ID=PD??FD;PD&&history.replaceState(null,``,window.location.pathname+window.location.search);var LD=null,RD=new rs(16777215,.5);kD.add(RD);var zD=new ns(16777215,1.5);kD.add(zD);var BD=new Zu;BD.scale.setScalar(4e5),kD.add(BD);var VD=new xE({renderer:AD,scene:kD,sky:BD,sunLight:zD,ambientLight:RD}),HD=null,UD=document.getElementById(`credits-toggle`),WD=document.getElementById(`credits`);function GD(e){WD.hidden=!e,UD.setAttribute(`aria-expanded`,String(e))}UD.addEventListener(`click`,e=>{e.stopPropagation(),GD(WD.hidden),UD.blur()}),document.addEventListener(`click`,e=>{!WD.hidden&&!e.target.closest(`#credits-box`)&&GD(!1)}),window.addEventListener(`keydown`,e=>{e.code===`Escape`&&GD(!1)});var KD={},qD=[`dem`,`demLiability`,`basemap`,`trails`,`osm`,`modified`];function JD(){document.getElementById(`credits`).innerHTML=qD.filter(e=>KD[e]).map(e=>KD[e]).join(`<br>`)}KD.modified=`Elevation and trail data adapted from the sources above: cropped to the park area, resampled, and merged from multiple datasets.`;var YD=!1,XD=null,ZD=null,QD=Dy().then(e=>{let{object:t,manifest:n,sampleRenderedHeight:r,update:i}=e;ZD=e,kD.add(t),XD=i,XD($),YD=!0,MD.getGroundHeight=r,ND.setSamplers({sampleGroundHeight:r});let a=n.source.sources.filter(e=>e.attribution);if(a.length){let e=e=>e.attribution.replace(/\s*[-–]\s*CC BY 4\.0\.?$/i,``),t=e=>/^CC BY 4\.0$/i.test(e.license??``),r=[],i=a.filter(t);i.length&&r.push(`${i.map(e).join(` `)} <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="noopener">CC BY 4.0</a>`);for(let n of a.filter(e=>!t(e)))r.push(n.licenseUrl?`${e(n)} (<a href="${n.licenseUrl}" target="_blank" rel="noopener">licence</a>)`:e(n));KD.dem=r.join(`<br>`);let o=n.source.sources.map(e=>e.liabilityNotice).filter(Boolean);o.length&&(KD.demLiability=o.join(` `)),JD()}let{xmin:o,ymin:s,xmax:c,ymax:l}=n.bboxCrsUnits;return LD={x:(c-o)/2,z:(l-s)/2},HD=new kE(kD,{worldWidth:c-o,worldDepth:l-s}),VD.weather=HD,e}),$D=jv().catch(e=>(console.warn(`Forest mask unavailable - continuing without trees:`,e.message),null)),eO=Pv().catch(e=>(console.warn(`Glacier mask unavailable - the ice will not be painted:`,e.message),null));$v(void 0,{maxTextureSize:AD.capabilities.maxTextureSize}).then(({manifest:e,level:t})=>{KD.basemap=`${e.source.attribution} (<a href="${e.source.licenseUrl}" target="_blank" rel="noopener">legal notice</a>)`,JD()}).catch(e=>{console.warn(`Satellite basemap unavailable - drawing the procedural ground:`,e.message)});var tO=IS().catch(e=>(console.warn(`Landcover mask unavailable - continuing without grass or shrubs:`,e.message),null));ly().catch(e=>(console.warn(`Outer-ring field unavailable - no edge fade, no boundary:`,e.message),null)).then(e=>{e&&(MD.getFade=cy(e))});var nO=null,rO=null,iO=null,aO=null,oO=null;Promise.all([QD,$D]).then(async([e,t])=>{let n=t?Av({manifest:t.manifest,texture:t.texture}):()=>0;t&&(rO=MS({manifest:e.manifest,heightTexture:e.heightTexture}),kD.add(rO.object),rO.applyDetail(),nO=Uw({sampleGroundHeight:e.sampleRenderedHeight,canopyAt:n,onAlarm:e=>ND.call(e)}),kD.add(nO.object));let r=await tO;if(r){aO=PC({manifest:e.manifest,heightTexture:e.heightTexture}),kD.add(aO.object),GO();let t=FS({manifest:r.manifest,texture:r.texture}),n=await eO,i=n?Av({manifest:n.manifest,texture:n.texture}):()=>0;oO=rw({sampleGroundHeight:e.sampleRenderedHeight,coverAt:t,iceAt:i}),kD.add(oO.object)}ND.setSamplers({canopyAt:n});let i=await _O.catch(()=>null);iO=mT({sampleGroundHeight:e.sampleRenderedHeight,canopyAt:n,pois:i?.manifest.pois??[],onCall:e=>ND.call(e)}),kD.add(iO.object)});var sO=null,cO=Nb().then(e=>(kD.add(e.group),sO=e,KD.trails=`${e.manifest.source.attribution} <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="noopener">${e.manifest.source.license}</a>`,JD(),e)),lO=15,uO=1.2,dO=null;function fO(e){let t=MD.getGroundHeight?.(e.local.x,e.local.z)??e.elevationM,n=new U(e.local.x,t,e.local.z),r=$.position.clone().sub(n);r.y=0,r.lengthSq()<1&&r.set(0,0,1),r.normalize();let i=n.clone().addScaledVector(r,lO);i.y=(MD.getGroundHeight?.(i.x,i.z)??n.y)+QE,dO={startPos:$.position.clone(),endPos:i,lookAt:n.clone(),t:0},MD.enabled=!1}function pO(e){document.getElementById(`poi-info`).innerHTML=Wb(e),document.getElementById(`poi-info`).style.display=`block`,fO(e)}var mO=null,hO=null,gO=null,_O=Hb(void 0,{onSelect:pO}).then(e=>{mO=e,kD.add(e.group),KD.osm=`${e.manifest.source.attribution} <a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noopener">${e.manifest.source.license}</a>`,JD();let t=new Map(e.searchEntries.map(e=>[e.label,e.poi])),n=document.getElementById(`poi-search-list`);for(let{label:t}of e.searchEntries){let e=document.createElement(`option`);e.value=t,n.appendChild(e)}let r=document.getElementById(`poi-search-input`);return r.addEventListener(`focus`,()=>{document.pointerLockElement&&document.exitPointerLock()}),r.addEventListener(`input`,()=>{let e=t.get(r.value);e&&(pO(e),r.value=``,r.blur())}),e});function vO(){let e=MD.getGroundHeight,t=mO?.manifest.pois;if(!e||!t?.length)return!1;let n=t.find(e=>e.name===`Le Pont`&&e.category===`trailhead`)??t.find(e=>e.category===`trailhead`)??t.find(e=>e.name===`Gran Paradiso`)??t[0];if(!n)return!1;let r=t.find(e=>e.name===`Gran Paradiso`)??n,i=new H(r.local.x-n.local.x,r.local.z-n.local.z);i.lengthSq()<1&&i.set(0,1),i.normalize();let a=n.local.x-i.x*20,o=n.local.z-i.y*20,s=e(a,o)+QE;return $.position.set(a,s,o),$.lookAt(a+i.x*400,s,o+i.y*400),MD.mode=`walk`,!0}var yO=new U;function bO(){if(!YD)return null;let{lat:e,lon:t}=iv($.position.x,$.position.z);return{lat:e,lon:t,alt:$.position.y,heading:IE($),pitch:RE($),mode:MD.mode,time:VD.fraction,sky:HD?HD.current:null,sound:ND.enabled,terrain:FO?Number(FO.value):null,models:KO?Number(KO.value):null,cover:WO?Number(WO.value):null}}function xO(e){if(!e)return!1;let t=MD.getGroundHeight;if(!t||!LD)return!1;let n;try{n=av(e.lat,e.lon)}catch{return!1}if(Math.abs(n.x)>LD.x||Math.abs(n.z)>LD.z)return!1;let r=t(n.x,n.z);if(!Number.isFinite(r))return!1;MD.mode=e.mode;let i=e.mode===`fly`?Math.max(e.alt,r+2):r+QE;if($.position.set(n.x,i,n.z),zE(e.heading,e.pitch,yO),$.lookAt($.position.x+yO.x*100,$.position.y+yO.y*100,$.position.z+yO.z*100),e.time!=null&&(VD.setTime(e.time),MO.value=String(e.time),NO.textContent=VD.label),e.sky&&HD){let t=wE.indexOf(e.sky);t>=0&&(HD.set(t),PO.value=String(t))}return!0}var SO=2,CO=0,wO=``,TO=!1;function EO(e,t){if(!e||t==null)return!1;let n=String(t);return[...e.options].some(e=>e.value===n)?(e.value=n,!0):!1}function DO(){if(!TO)return;let e=bO();if(!e)return;let t=`${wD(e)}&s=${+!!e.sound}&t=${e.terrain}&m=${e.models}&c=${e.cover}`;t!==wO&&(wO=t,DD(e))}document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`hidden`&&DO()}),window.addEventListener(`pagehide`,DO),Promise.all([QD,_O,cO]).then(([{sampleRenderedHeight:e},t,n])=>{t.alignToGround(e),n.alignToGround(e),hO=yx({pois:t.manifest.pois.filter(e=>e.category===`hut`),sampleHeight:e}),kD.add(hO.group),hO.update($),AO({name:`huts`,alignToGround:hO.alignToGround}),gO=kx({pois:t.manifest.pois,sampleHeight:e}),kD.add(gO.group),AO({name:`summit-monuments`,alignToGround:gO.alignToGround}),t.setBuildingProbe(hO.hasBuilding),qO(),AO({name:`poi`,alignToGround:t.alignToGround}),AO({name:`trails`,alignToGround:n.alignToGround}),VO(),xO(ID)||vO(),ID=null,TO=!0,DO()});var OO=null,kO=[];function AO(e){if(kO.push(e),ZD)try{e.alignToGround(ZD.sampleRenderedHeight)}catch(t){console.error(`Could not seat ${e.name} on the drawn surface:`,t.message)}}var jO=null;oS().then(e=>{let{group:t,manifest:n,alignToGround:r}=e;jO=e,kD.add(t),AO({name:`roads`,alignToGround:r}),KD.osm=`${n.source.attribution} <a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noopener">${n.source.license}</a>`,JD()}),tS().then(({group:e,manifest:t,update:n,alignToGround:r})=>{kD.add(e),OO=n,AO({name:`water`,alignToGround:r}),ND.setWater(t),KD.osm=`${t.source.attribution} <a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noopener">${t.source.license}</a>`,JD()}),AD.domElement.addEventListener(`click`,()=>{document.getElementById(`poi-info`).style.display=`none`,ND.enabled&&ND.start()}),window.addEventListener(`resize`,()=>{$.aspect=window.innerWidth/window.innerHeight,$.updateProjectionMatrix(),AD.setSize(window.innerWidth,window.innerHeight),jD.setSize(window.innerWidth,window.innerHeight),jO?.setResolution(window.innerWidth,window.innerHeight),sO?.setResolution(window.innerWidth,window.innerHeight)});var MO=document.getElementById(`env-time`),NO=document.getElementById(`env-time-label`);MO.addEventListener(`input`,()=>{VD.setTime(Number(MO.value)),NO.textContent=VD.label}),NO.textContent=VD.label;var PO=document.getElementById(`env-weather`);PO.addEventListener(`change`,()=>{HD?.set(Number(PO.value))});var FO=document.getElementById(`env-terrain`),IO=.5,LO=0,RO=0,zO=null;function BO(e){if(RO=e,LO===e)return Promise.resolve();let t=zO,n=new Promise(e=>{zO=e});return t?.(),n}function VO(){if(!ZD)return;let e=ZD.sampleRenderedHeight;for(let t of kO)try{t.alignToGround(e)}catch(e){console.error(`Could not re-seat ${t.name} on the drawn surface:`,e.message)}}function HO(e){if(!ZD||LO===RO)return;let t=e/IO,n=RO-LO;LO+=Math.sign(n)*Math.min(t,Math.abs(n)),ZD.setHeightTierMix(LO),VO(),LO===RO&&(zO?.(),zO=null)}async function UO(){if(!FO)return;let e=Number(FO.value);if(!e){await BO(0);return}let t=e-1,n=ZD?.heightTierLevel?.()??-1;FO.disabled=!0;try{n>=0&&n!==t&&LO>0&&await BO(0),await ZD?.loadHeightTier(t)?await BO(1):FO.value=`0`}catch(e){console.error(`The high-resolution terrain failed to load:`,e.message),FO.value=`0`}finally{FO.disabled=!1}}if(FO){FO.addEventListener(`change`,()=>{UO()});let e=async()=>{let e=ZD?.manifest?.resolutionMPerPx?.x,t=await(ZD?.heightTierManifest?.()??null);for(let n of FO.options){let r=n.dataset.name,i=Number(n.value)-1;if(i<0){e&&(n.textContent=`${r} · ${e.toFixed(1)} m`);continue}let a=t?.levels?.[i];if(!a){n.disabled=!0,n.textContent=`${r} · unavailable`;continue}let o=a.file.gzipBytes/1048576;n.textContent=`${r} · ${a.resolutionMPerPx.x.toFixed(0)} m · ${o<10?o.toFixed(1):o.toFixed(0)} MB`}};EO(FO,FD?.terrain),QD.then(()=>{e(),requestAnimationFrame(()=>{UO()})})}var WO=document.getElementById(`env-groundcover`);function GO(){EC.value=Number(WO.value),aO?.applyDensity()}WO.addEventListener(`change`,GO),EO(WO,FD?.cover),EC.value=Number(WO.value);var KO=document.getElementById(`env-models`);function qO(){Jb(Number(KO.value)),rO?.applyDetail(),hO?.applyDetail(),gO?.applyDetail()}KO.addEventListener(`change`,qO),EO(KO,FD?.models),qO();var JO=document.getElementById(`env-audio`);function YO(e){ND.setEnabled(e),JO.checked=e}JO.addEventListener(`change`,()=>{YO(JO.checked),JO.blur()}),window.addEventListener(`keydown`,e=>{e.code===`KeyM`&&(hD(document.activeElement)||YO(!ND.enabled))}),FD&&typeof FD.sound==`boolean`&&YO(FD.sound);var XO=document.getElementById(`copy-link`);XO.addEventListener(`click`,async e=>{e.stopPropagation(),XO.blur();let t=bO();if(!t)return;let n=wD(t);history.replaceState(null,``,n);let r=window.location.href,i=!1;try{await navigator.clipboard.writeText(r),i=!0}catch{i=!1}XO.textContent=i?`link copied`:`link in the address bar`,setTimeout(()=>{XO.textContent=`copy link`},2e3)});var ZO=document.getElementById(`reset-view`);ZO.addEventListener(`click`,e=>{e.stopPropagation(),ZO.blur(),vO()&&(history.replaceState(null,``,window.location.pathname+window.location.search),DO())});var QO=new ls,$O=document.getElementById(`fps`),ek=0,tk=0,nk=document.getElementById(`compass-needle`),rk=document.getElementById(`nav-heading`),ik=document.getElementById(`nav-position`),ak=document.getElementById(`nav-nearest`),ok=document.getElementById(`nav-flower`),sk=0;function ck(e,t){let n=e>=0?`N`:`S`,r=t>=0?`E`:`W`;return`${Math.abs(e).toFixed(4)}°${n}, ${Math.abs(t).toFixed(4)}°${r}`}AD.setAnimationLoop(()=>{if(QO.update(),OO?.(QO.getElapsed()),HD?.update(QO.getDelta(),$),nO?.update(QO.getDelta(),$),rO?.update($),iO?.update(QO.getDelta(),$),VD.applyState(),fE(BD,$.position.y),Fv.value=HD?.mod.snow??0,TC.value=QO.getElapsed(),wC.value=HD?.mod.wind??0,oO?.update($),hO?.update($),HO(QO.getDelta()),ek+=1,tk+=QO.getDelta(),tk>=.5&&($O.textContent=`${Math.round(ek/tk)} fps`,ek=0,tk=0),CO+=QO.getDelta(),CO>=SO&&(CO=0,DO()),sk+=QO.getDelta(),sk>=.25){sk=0;let e=IE($);nk.style.transform=`translate(-50%, -100%) rotate(${e}deg)`;let t=RE($);if(rk.textContent=`${LE(e)} ${Math.round(e)}° · pitch ${t>=0?`+`:`-`}${Math.abs(t).toFixed(0)}°`,YD){let{lat:e,lon:t}=iv($.position.x,$.position.z),n=MD.getGroundHeight?.($.position.x,$.position.z),r=n==null?``:` · ground ${Math.round(n)} m`;ik.textContent=`${ck(e,t)} · alt ${Math.round($.position.y)} m${r}`}let n=mO&&BE($.position.x,$.position.z,mO.manifest.pois),r=n&&(n.distanceM<1e3?`${Math.round(n.distanceM)} m`:`${(n.distanceM/1e3).toFixed(1)} km`);if(ak.textContent=n?`Near ${n.poi.name} (${r})`:``,ok){let e=oO?.diag;!e||e.nearestM===null?ok.textContent=e?.foundCount?`Edelweiss found: ${e.foundCount}`:``:e.nearestM<=6?ok.textContent=`Edelweiss, right here (${e.foundCount} found)`:ok.textContent=`Edelweiss ${Math.round(e.nearestM)} m away, ${Math.round(e.nearestElevM)} m`+(e.foundCount?` · ${e.foundCount} found`:``)}mO?.updateMarkers($),sO?.updateLabels($)}if(dO){dO.t=Math.min(1,dO.t+QO.getDelta()/uO);let e=1-(1-dO.t)**3;$.position.lerpVectors(dO.startPos,dO.endPos,e),$.lookAt(dO.lookAt),dO.t>=1&&(dO=null,MD.enabled=!0)}MD.update(QO.getDelta()),ND.update(QO.getDelta(),$,HD,VD,MD),XD?.($),AD.render(kD,$),jD.render(kD,$)});